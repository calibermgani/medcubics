...
<div class="col-md-12" style="margin-top: -13px; padding-top: 0px;"><!-- Inner Content for full width Starts -->
    <div class="box-body-block" style="border:1px solid #f2e099;"><!--Background color for Inner Content Starts -->
          ...
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 yes-border no-padding"><!-- General Details Full width Starts -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12  no-padding"><!-- Only general details content starts -->
                <div class="box no-border  no-shadow"><!-- Box Starts -->
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12" style="background: #fffbeb"><!--  1st Content Starts -->
                        ...
                        <div class="box-body form-horizontal"><!-- Box Body Starts -->
                            <div class="form-group-billing">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-10 billing-select2-disabled-yellow  @if($errors->first('rendering_provider_id')) error @endif">
                                    {!! Form::select('rendering_provider_id', array('' => 'Carey, Mariah E') + (array)$rendering_providers,  $rendering_provider_id,['class'=>'select2 form-control','readonly'=>'readonly','disabled'=>'disabled','style'=>'background:red !important;']) !!}  
                            ...
                            <div class="form-group-billing">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-10 billing-select2-disabled-yellow @if($errors->first('referring_provider_id')) error @endif">
                                    {!! Form::select('referring_provider_id', array('' => 'James, Allen') + (array)$referring_providers,  $referring_provider_id,['class'=>'select2 form-control']) !!}  
                            ...
                            <div class="form-group-billing">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-10 billing-select2-disabled-yellow @if($errors->first('billing_provider_id')) error @endif">
                                    {!! Form::select('billing_provider_id', array('' => 'Martin, Lu K') + (array)$billing_providers,  $billing_provider_id,['class'=>'select2 form-control','readonly'=>'readonly','disabled'=>'disabled']) !!}  
                            ...
                            <div class="form-group-billing">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-10 billing-select2-disabled-yellow @if($errors->first('facility_id')) error @endif">  
                                    {!! Form::select('facility_id', (array)$facilities,  $facility_id,['class'=>'select2 form-control','id'=>'facility_id','readonly'=>'readonly','disabled'=>'disabled']) !!}
                            ...
                            <div class="form-group-billing">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-10 billing-select2-disabled-yellow">  
                            ...
                            <div class="form-group-billing">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-10">  
                                    {!! Form::text('authorization','42432',['maxlength'=>'25','class'=>'form-control input-sm-header-billing','style'=>'background:#fffbeb;','readonly'=>'readonly']) !!}
                                </div>   
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 no-padding" style="background: #fffbeb;  border-left: 1px solid #f0f0f0;"><!--  2nd Content Starts -->
                        ...
                        <div class="box-body form-horizontal js-address-class" id="js-address-primary-address">
                            ...
                            <div class="form-group-billing">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-7 col-xs-10 billing-select2-disabled-yellow">
                                    {!! Form::select('insurance_id', array(''=>'Patient ')+(array)$insurances,  $insurance_id,['class'=>'select2 form-control','id'=>'insurance_id','readonly'=>'readonly','disabled']) !!}
                                </div>                                                     
                            </div>
                            ...
                            <div class="form-group-billing">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-7 col-xs-10">
                                    {!! Form::text('employer','H - M',['class'=>' form-control input-sm-header-billing','style'=>'background:#fffbeb;','readonly'=>'readonly']) !!}
                                </div>                                                       
                            </div>
                            ...
                            <div class="form-group-billing">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-7 col-xs-10 billing-select2">
                                    {!! Form::text('employer','Victoria Bellot',['class'=>' form-control input-sm-header-billing','style'=>'background:#fffbeb;']) !!}
                                </div>    
                                <div class="col-lg-1 col-md-1 col-sm-2 col-xs-2">
                                    <div class="dropdown user user-menu">
                                        <a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                            ...
                            <div class="form-group-billing">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-7 col-xs-10">
                                   {!! Form::text('employer','Ambulance',['class'=>' form-control input-sm-header-billing','style'=>'background:#fffbeb;','readonly'=>'readonly']) !!}
                                </div>                                                       
                            </div>

                            <div class="form-group-billing">
                                {!! Form::label('Copay', 'Co-Pay',  ['class'=>'col-lg-4 col-md-4 col-sm-5 col-xs-12 control-label-billing med-green']) !!} 
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-10 billing-select2-disabled-yellow">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-10">                                                                        
                                    {!! Form::text('doi',350000,['class'=>'form-control input-sm-header-billing','style'=>'background:#fffbeb;']) !!}                    
                                </div>    
                            </div>
                            ...
                            <div class="form-group-billing">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-7 col-xs-10 billing-select2">
                                    {!! Form::text('copay','General Details',['class'=>'form-control input-sm-header-billing','style'=>'background:#fffbeb;']) !!}
                                </div>                          
                            </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 left-border" style="background: #fffbeb; "><!-- ICD Details Starts here -->
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 med-orange  no-padding" style="margin-top: -10px;">
                        ...
                        <div class="box-body form-horizontal">
                            ...
                            <div class="form-group-billing">                            
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-3 col-xs-10">
                                    {!! Form::text('doi','G44.81',['class'=>'form-control input-sm-header-billing','style'=>'background:#fffbeb;']) !!}
                                </div>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-3 col-xs-10">
                                    {!! Form::text('billed_date','O89.4',['class'=>'form-control input-sm-header-billing','style'=>'background:#fffbeb;']) !!}                    
                                </div>
                                <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">
                                    <i class="fa fa-info med-green form-icon-billing"></i>
                                </div>
                            ...
                            <div class="form-group-billing">                            
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-3 col-xs-10">
                                    {!! Form::text('doi','G44.009',['class'=>'form-control input-sm-header-billing','style'=>'background:#fffbeb;']) !!}
                                </div>
                                <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">
                                    <i class="fa fa-info med-green form-icon-billing"></i>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-3 col-xs-10">
                                    {!! Form::text('billed_date','G44.52',['class'=>'form-control input-sm-header-billing','style'=>'background:#fffbeb;']) !!}                    
                                </div>     
                                <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">
                                    <i class="fa fa-info med-green form-icon-billing"></i>
                                </div>
                            ...
                            <div class="form-group-billing">                            
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-3 col-xs-10">
                                    {!! Form::text('doi','O29.43',['class'=>'form-control input-sm-header-billing','style'=>'background:#fffbeb;']) !!}
                                </div>
                                <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">
                                    <i class="fa fa-info med-green form-icon-billing"></i>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-3 col-xs-10">
                                    {!! Form::text('billed_date','G44.029',['class'=>'form-control input-sm-header-billing','style'=>'background:#fffbeb;']) !!}                    
                                </div>          
                                <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">
                                    <i class="fa fa-info med-green form-icon-billing"></i>
                                </div>
                            ...
                            <div class="form-group-billing">                            
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-3 col-xs-10">
                                    {!! Form::text('doi','Z85.020',['class'=>'form-control input-sm-header-billing','style'=>'background:#fffbeb;']) !!}
                                </div>
                                <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">
                                    <i class="fa fa-info med-green form-icon-billing"></i>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-3 col-xs-10">
                                    {!! Form::text('billed_date','D3A.092',['class'=>'form-control input-sm-header-billing','style'=>'background:#fffbeb;']) !!}                    
                                </div>      
                                <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">
                                    <i class="fa fa-info med-green form-icon-billing"></i>
                                </div>
                            ...
                            <div class="form-group-billing">                            
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-3 col-xs-10">
                                    {!! Form::text('doi','K31.819',['class'=>'form-control input-sm-header-billing','style'=>'background:#fffbeb;']) !!}
                                </div>
                                <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">
                                    <i class="fa fa-info med-green form-icon-billing"></i>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-3 col-xs-10">
                                    {!! Form::text('billed_date','A96.1',['class'=>'form-control input-sm-header-billing','style'=>'background:#fffbeb;']) !!}                    
                                </div>                   
                                <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">
                                    <i class="fa fa-info med-green form-icon-billing"></i>
                                </div>
                            ...
                            <div class="form-group-billing margin-b-5">                            
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-3 col-xs-10">
                                    {!! Form::text('doi','R50.82',['class'=>'form-control input-sm-header-billing','style'=>'background:#fffbeb;']) !!}
                                </div>
                                <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">
                                    <i class="fa fa-info med-green form-icon-billing"></i>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-3 col-xs-10">
                                    {!! Form::text('billed_date','A01.09',['class'=>'form-control input-sm-header-billing','style'=>'background:#fffbeb;']) !!}                    
                                </div>     
                                <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">
                                    <i class="fa fa-info med-green form-icon-billing"></i>
                                </div>
  ...
  <div id = "demo" class="collapse out col-md-12 space10"><!-- Inner Content for full width Starts -->
      <div class="box-body-block" style="border:1px solid #85E2E6;"><!--Background color for Inner Content Starts -->

        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 no-padding">
            
            
            
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 yes-border no-padding" style=" background: #e5faf0;">
               
                
            
                <div class="box no-border  no-shadow"><!-- Box Starts -->
                    
                    <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 no-padding" ><!--  1st Content Starts -->
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 med-orange no-padding" style="margin-top: -10px;">
                        ...
                        <div class="box-body form-horizontal no-padding"><!-- Box Body Starts -->
                            ...
                            <ul class="billing-edit" style="list-style-type:none; padding:0px; line-height:26px;  border-radius:4px;" id="">
                                <li class="billing-grid-edit">
                                    <table class="table-billing-view" style="width: 100%;">
                                        <thead>
                                            <tr>

                                                <th style="text-align: center;  color:#00877f;  background: #e5faf0; font-weight: 600; width: 13%;">Who Paid</th>                                                
                                                <th style="text-align: center;  color:#00877f;  background: #e5faf0; font-weight: 600; width: 7%">Posting Date</th>                                
                                                <th style="text-align: center;  color:#00877f;  background: #e5faf0; font-weight: 600; width: 7%">Check Date</th>
                                                <th style="text-align: center;  color:#00877f;  background: #e5faf0; font-weight: 600; width: 10%">Check No</th>
                                                <th style="text-align: center;  color:#00877f;  background: #e5faf0; font-weight: 600; width: 7%">Deposit Date</th>                               
                                                <th style="text-align: center;  color:#00877f;  background: #e5faf0; font-weight: 600; width: 7%">Ref No</th>                                                                                           
                                            </tr>
                                        </thead>
                                    </table>                                     
                                </li>
                                    ...
                                    <table class="table-billing-view superbill-claim">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td style="text-align: center; width: 13%;"><input type="text" value="Peter, Thomas" style="border: 0px solid #e8e8e8; background: #e5faf0; width: 100%; border-radius: 4px; text-align: center;"></td>                                             
                                                <td style="text-align: center; width: 7%;"><input type="text" value="12-21-2015" style="border: 0px solid #e8e8e8; background: #e5faf0; width: 100%; border-radius: 4px; text-align: center;"></td>                                   
                                                <td style="text-align: center; width: 7%;"> <input type="text" value="01-15-2016" style="border: 0px solid #e8e8e8; background: #e5faf0; width: 100%; border-radius: 4px; text-align: center;"></td>  
                                                <td style="text-align: center; width: 10%"><input type="text" value="34545 454 8676" style="border: 0px solid #e8e8e8; background: #e5faf0; width: 100%; border-radius: 4px; text-align: center;"></td>
                                                <td style="text-align: center; width: 7%"><input type="text" value="12-29-2015" style="border: 0px solid #e8e8e8; background: #e5faf0; width: 100%; border-radius: 4px; text-align: center;"></td>                                
                                                <td style="text-align: center; width: 7%"><input type="text" value="3434535" style="border: 0px solid #e8e8e8; background: #e5faf0; width: 100%; border-radius: 4px; text-align: center;"></td>                                                                                      
                                            </tr>
                                        </tbody>
                                    </table>                                     
                                </li>
                                ...
                                <li class="billing-grid-edit">
                                    <table class="table-billing-view superbill-claim">
                                        <tbody>
                                            <tr>                                 
                                                <td style="text-align: center; width: 13%;"><input type="text" value="Baker, Russell S" style="border: 0px solid #e8e8e8; background: #e5faf0; width: 100%; border-radius: 4px; text-align: center;"></td>                                             
                                                <td style="text-align: center; width: 7%;"><input type="text" value="1-09-2016" style="border: 0px solid #e8e8e8; background: #e5faf0; width: 100%; border-radius: 4px; text-align: center;"></td>                                   
                                                <td style="text-align: center; width: 7%;"> <input type="text" value="1-20-2016" style="border: 0px solid #e8e8e8; background: #e5faf0; width: 100%; border-radius: 4px; text-align: center;"></td>  
                                                <td style="text-align: center; width: 10%"><input type="text" value="86744 647 2327" style="border: 0px solid #e8e8e8; background: #e5faf0; width: 100%; border-radius: 4px; text-align: center;"></td>
                                                <td style="text-align: center; width: 7%"><input type="text" value="1-22-2016" style="border: 0px solid #e8e8e8; width: 100%; background: #e5faf0; border-radius: 4px; text-align: center;"></td>                                
                                                <td style="text-align: center; width: 7%; border-bottom: 1px solid #646464;"><input type="text" value="68567545" style="border: 0px solid #e8e8e8; background: #e5faf0; width: 100%; border-radius: 4px; text-align: center;"></td>
                                ...
                                <li class="billing-grid-edit">
                                    <table class="table-billing-view superbill-claim">
                                        <tbody>
                                            <tr>                               
                                                <td style="text-align: center; width: 13%;"><input type="text" value="Brian, Jose" style="border: 0px solid #e8e8e8; background: #e5faf0; width: 100%; border-radius: 4px; text-align: center;"></td>                                             
                                                <td style="text-align: center; width: 7%;"><input type="text" value="11-18-2015" style="border: 0px solid #e8e8e8; background: #e5faf0; width: 100%; border-radius: 4px; text-align: center;"></td>                                   
                                                <td style="text-align: center; width: 7%;"> <input type="text" value="12-21-2015" style="border: 0px solid #e8e8e8; background: #e5faf0; width: 100%; border-radius: 4px; text-align: center;"></td>  
                                                <td style="text-align: center; width: 10%"><input type="text" value="74565 232 6453" style="border: 0px solid #e8e8e8; background: #e5faf0; width: 100%; border-radius: 4px; text-align: center;"></td>
                                                <td style="text-align: center; width: 7%"><input type="text" value="1-20-2016" style="border: 0px solid #e8e8e8; background: #e5faf0; width: 100%; border-radius: 4px; text-align: center;"></td>                                
                                                <td style="text-align: center; width: 7%"><input type="text" value="6546565" style="border: 0px solid #e8e8e8; background: #e5faf0; width: 100%; border-radius: 4px; text-align: center;"></td>                                                                                    
                                            </tr>
                                        </tbody>
                                    </table>                                     
                                </li>

                                <li class="billing-grid-edit" style="border-bottom: 1px dotted #85e2e6;">
                                    <table class="table-billing-view superbill-claim">
                                        <tbody>
                                            <tr>                              
                                                <td style="text-align: center; width: 13%;"><input type="text" class="" style="border: 0px solid #e8e8e8; background: #e5faf0; width: 100%; border-radius: 4px; text-align: center;"></td>                                             
                                                <td style="text-align: center; width: 7%;"><input type="text" class="" style="border: 0px solid #e8e8e8; background: #e5faf0; width: 100%; border-radius: 4px; text-align: center;"></td>                                   
                                                <td style="text-align: center; width: 7%;"> <input type="text" class="" style="border: 0px solid #e8e8e8; background: #e5faf0; width: 100%; border-radius: 4px; text-align: center;"></td>  
                                                <td style="text-align: center; width: 10%"><input type="text" class="" style="border: 0px solid #e8e8e8; background: #e5faf0; width: 100%; border-radius: 4px; text-align: center;"></td>
                                                <td style="text-align: center; width: 7%"><input type="text" class="" style="border: 0px solid #e8e8e8; background: #e5faf0; width: 100%; border-radius: 4px; text-align: center;"></td>                                
                                                <td style="text-align: center; width: 7%"><input type="text" class="" style="border: 0px solid #e8e8e8; background: #e5faf0; width: 100%; border-radius: 4px; text-align: center;"></td>                                
                                            </tr>
                                        </tbody>
                     ...
                     <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 no-padding" style="background: #f7fce6;  border-left: 1px solid #f0f0f0;"><!--  2nd Content Starts -->
                        ...
                        <div class="box-body form-horizontal js-address-class" id="js-address-primary-address">
                            ...
                            <div class="form-group-billing">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-7 col-xs-10 billing-select2-disabled-green">
                                    {!! Form::select('insurance_id', array(''=>'-- Select --')+(array)$insurances,  $insurance_id,['class'=>'select2 form-control','id'=>'insurance_id']) !!}
                                </div>                                                     
                            </div>
            ...
            <div class="col-lg-7 col-md-7 col-sm-7 col-xs-12 billing-select2-disabled-green">
...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 no-padding">
        <div class="btn-group">
            ...
            <div class="btn-group pull-right">
                <button type = "button" class = "btn-min btn-success" style="background: #fff; border:0px solid #ccc; color:#00877f;"data-toggle = "collapse" data-target = "#demo"><i class="fa fa-money" style="color:#ccc"></i> Payments</button>
                <button type="button" class="btn-min btn-success" style="background: #fff; border-top:0px solid #ccc; border-bottom:0px solid #ccc;" ><a href="#others" data-toggle="modal" data-target="#transaction_details"><i class="fa fa-exchange" style="color:#ccc"></i> Transactions</a></button>
                <button type="button" class="btn-min btn-success" style="background: #fff; border-top:0px solid #ccc; border-bottom:0px solid #ccc;" ><a href="#others" data-toggle="modal" data-target="#others" ><i class="fa fa-list-ol" style="color:#ccc"></i> Workbench</a></button>
                <button type="button" class="btn-min btn-success" style="background: #fff; border-top:0px solid #ccc; border-bottom:0px solid #ccc;" ><a href="#others" data-toggle="modal" data-target="#others" ><i class="fa fa-file" style="color:#ccc"></i> CMS 1500</a></button>
                <button type="button" class="btn-min btn-success" style="background: #fff; border-top:0px solid #ccc; border-bottom:0px solid #ccc;" ><a href="#others" data-toggle="modal" data-target="#others" ><i class="fa fa-check" style="color:#ccc"></i> Re-Submit</a></button>
                <button type="button" class="btn-min btn-success" style="background: #fff; border-right:0px solid #ccc;  border-top:0px solid #ccc; border-bottom:0px solid #ccc;" ><a href="#others" data-toggle="modal" data-target="#others" ><i class="fa fa-check" style="color:#ccc"></i> Submit</a></button>      
            </div>
