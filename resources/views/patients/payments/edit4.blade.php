...
@include ('patients/billing/tabs1') 
@stop

@section('practice')
<div class="col-md-12" style="margin-top: -13px; padding-top: 0px;"><!-- Inner Content for full width Starts -->
    <div class="box-body-block" style="border:1px solid #ccc;"><!--Background color for Inner Content Starts -->

        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 yes-border no-padding" style="border-color:#d7e82a"><!-- General Details Full width Starts -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12  no-padding"><!-- Only general details content starts -->
                <div class="box no-border  no-shadow"><!-- Box Starts -->
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12" style="background: #f6fdbd"><!--  1st Content Starts -->
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 med-orange no-padding" style="margin-top: -10px;">
                            <span class="bg-white" style="padding:0px 4px;">General Details</span>
                        </div>
                        <div class="box-body form-horizontal"><!-- Box Body Starts -->
                            <div class="form-group-billing">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-10 billing-select2-disabled-yellow  @if($errors->first('rendering_provider_id')) error @endif">
                                    {!! Form::select('rendering_provider_id', array('' => 'Carey, Mariah E') + (array)$rendering_providers,  $rendering_provider_id,['class'=>'select2 form-control','readonly'=>'readonly','disabled'=>'disabled']) !!}  
                            ...
                            <div class="form-group-billing">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-10">  
                                    {!! Form::text('authorization','42432',['maxlength'=>'25','class'=>'form-control input-sm-header-billing','style'=>'background:#f6fdbd;','readonly'=>'readonly']) !!}
                                </div>   
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 no-padding" style="background: #f6fdbd;  border-left: 1px solid #d7e82a;"><!--  2nd Content Starts -->
                        ...
                        <div class="box-body form-horizontal js-address-class" id="js-address-primary-address">
                            ...
                            <div class="form-group-billing">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-7 col-xs-10">
                                    {!! Form::text('employer','H - M',['class'=>' form-control input-sm-header-billing','style'=>'background:#f6fdbd;','readonly'=>'readonly']) !!}
                                </div>                                                       
                            </div>
                            ...
                            <div class="form-group-billing">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-7 col-xs-10 billing-select2">
                                    {!! Form::text('employer','Victoria Bellot',['class'=>' form-control input-sm-header-billing','style'=>'background:#f6fdbd;']) !!}
                                </div>    
                                <div class="col-lg-1 col-md-1 col-sm-2 col-xs-2">
                                    <div class="dropdown user user-menu">
                                        <a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                            ...
                            <div class="form-group-billing">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-7 col-xs-10">
                                   {!! Form::text('employer','Ambulance',['class'=>' form-control input-sm-header-billing','style'=>'background:#f6fdbd;','readonly'=>'readonly']) !!}
                                </div>                                                       
                            </div>
                            ...
                            <div class="form-group-billing">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-10">                                                                        
                                    {!! Form::text('doi',350000,['class'=>'form-control input-sm-header-billing','style'=>'background:#f6fdbd;']) !!}                    
                                </div>    
                            </div>
                            ...
                            <div class="form-group-billing">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-7 col-xs-10 billing-select2">
                                    {!! Form::text('copay','General Details',['class'=>'form-control input-sm-header-billing','style'=>'background:#f6fdbd;']) !!}
                                </div>                          
                            </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 left-border" style="background: #f6fdbd; border-color: #d7e82a "><!-- ICD Details Starts here -->
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 med-orange  no-padding" style="margin-top: -10px;">
                            <span class="bg-white" style="padding:0px 4px;">Diagnosis - ICD 10</span>
                        </div>
                        <div class="box-body form-horizontal">
                            ...
                            <div class="form-group-billing">                            
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-3 col-xs-10">
                                    {!! Form::text('doi','G44.81',['class'=>'form-control input-sm-header-billing','style'=>'background:#f6fdbd;']) !!}
                                </div>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-3 col-xs-10">
                                    {!! Form::text('billed_date','O89.4',['class'=>'form-control input-sm-header-billing','style'=>'background:#f6fdbd;']) !!}                    
                                </div>
                                <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">
                                    <i class="fa fa-info med-green form-icon-billing"></i>
                                </div>
                            ...
                            <div class="form-group-billing">                            
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-3 col-xs-10">
                                    {!! Form::text('doi','G44.009',['class'=>'form-control input-sm-header-billing','style'=>'background:#f6fdbd;']) !!}
                                </div>
                                <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">
                                    <i class="fa fa-info med-green form-icon-billing"></i>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-3 col-xs-10">
                                    {!! Form::text('billed_date','G44.52',['class'=>'form-control input-sm-header-billing','style'=>'background:#f6fdbd;']) !!}                    
                                </div>     
                                <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">
                                    <i class="fa fa-info med-green form-icon-billing"></i>
                                </div>
                            ...
                            <div class="form-group-billing">                            
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-3 col-xs-10">
                                    {!! Form::text('doi','O29.43',['class'=>'form-control input-sm-header-billing','style'=>'background:#f6fdbd;']) !!}
                                </div>
                                <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">
                                    <i class="fa fa-info med-green form-icon-billing"></i>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-3 col-xs-10">
                                    {!! Form::text('billed_date','G44.029',['class'=>'form-control input-sm-header-billing','style'=>'background:#f6fdbd;']) !!}                    
                                </div>          
                                <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">
                                    <i class="fa fa-info med-green form-icon-billing"></i>
                                </div>
                            ...
                            <div class="form-group-billing">                            
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-3 col-xs-10">
                                    {!! Form::text('doi','Z85.020',['class'=>'form-control input-sm-header-billing','style'=>'background:#f6fdbd; border-color:#b4d41b']) !!}
                                </div>
                                <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">
                                    <i class="fa fa-info med-green form-icon-billing"></i>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-3 col-xs-10">
                                    {!! Form::text('billed_date','D3A.092',['class'=>'form-control input-sm-header-billing','style'=>'background:#f6fdbd; border-color:#b4d41b']) !!}                    
                                </div>      
                                <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">
                                    <i class="fa fa-info med-green form-icon-billing"></i>
                                </div>
                            ...
                            <div class="form-group-billing">                            
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-3 col-xs-10">
                                    {!! Form::text('doi','K31.819',['class'=>'form-control input-sm-header-billing','style'=>'background:#f6fdbd; border-color:#b4d41b']) !!}
                                </div>
                                <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">
                                    <i class="fa fa-info med-green form-icon-billing"></i>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-3 col-xs-10">
                                    {!! Form::text('billed_date','A96.1',['class'=>'form-control input-sm-header-billing','style'=>'background:#f6fdbd; border-color:#b4d41b']) !!}                    
                                </div>                   
                                <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">
                                    <i class="fa fa-info med-green form-icon-billing"></i>
                                </div>
                            ...
                            <div class="form-group-billing margin-b-5">                            
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-3 col-xs-10">
                                    {!! Form::text('doi','R50.82',['class'=>'form-control input-sm-header-billing','style'=>'background:#f6fdbd; border-color:#b4d41b']) !!}
                                </div>
                                <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">
                                    <i class="fa fa-info med-green form-icon-billing"></i>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-3 col-xs-10">
                                    {!! Form::text('billed_date','A01.09',['class'=>'form-control input-sm-header-billing','style'=>'background:#f6fdbd; border-color:#b4d41b']) !!}                    
                                </div>     
                                <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">
                                    <i class="fa fa-info med-green form-icon-billing"></i>
                                </div>
 ...
 <div id = "demo" class="collapse out col-md-12 space10"><!-- Inner Content for full width Starts -->
      <div class="box-body-block" style="border:1px solid #ccc;"><!--Background color for Inner Content Starts -->
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 no-padding">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 yes-border no-padding" style=" background: #e5faf0; border-color: #9aebc4;">
               
                
            
                <div class="box no-border  no-shadow"><!-- Box Starts -->
                    
                    <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 no-padding" ><!--  1st Content Starts -->
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 med-orange no-padding" style="margin-top: -10px;">
                            <span class="bg-white" style="padding: 0px 4px; margin-left: 5px;">Payment Details</span>
                            
                        </div>
                        <div class="box-body form-horizontal no-padding table-responsive"><!-- Box Body Starts -->
                            
                           
                                    <table class="table table-billing-edit" style="width: 100%;">
                                        <thead>
                                            <tr>
                                                <th style="color:#00877f;  background: #e5faf0; font-weight: 600; width: 2%;">&emsp;</th>                                                
                                                <th style="color:#00877f;  background: #e5faf0; font-weight: 600; width: 13%;">Who Paid</th>                                                
                                                <th style="color:#00877f;  background: #e5faf0; font-weight: 600; width: 8%">Posting Date</th>                                
                                                <th style="color:#00877f;  background: #e5faf0; font-weight: 600; width: 8%">Check Date</th>
                                                <th style="color:#00877f;  background: #e5faf0; font-weight: 600; width: 10%">Check No</th>
                                                <th style="color:#00877f;  background: #e5faf0; font-weight: 600; width: 8%">Deposit Date</th>                               
                                                <th style="color:#00877f;  background: #e5faf0; font-weight: 600; width: 8%">Ref No</th>
                                                <th style="color:#00877f;  background: #e5faf0; font-weight: 600; width: 10%">Last Submitted</th>
                                            </tr>
                                        </thead>
                                        
                                        <tbody>
                                            <tr>                      
                                                <td style="width: 2%;"><input type="checkbox" class="flat-red"></td>
                                                <td style="width: 13%;">Hanover Insurance</td>                                             
                                                <td style="width: 8%;">1-09-2016</td>                                   
                                                <td style="width: 8%;">1-20-2016 </td>  
                                                <td style="width: 10%">86744 647 2327</td>
                                                <td style="width: 8%">1-22-2016</td>                                
                                                <td style="width: 8%;">43534656</td>
                                                <td style="width: 10%;">9-22-2015</td>
                                            </tr>
                                            
                                            <tr>                                 
                                                <td style="width: 2%;"><input type="checkbox" class="flat-red"></td>
                                                <td style="width: 13%;">Unicare Health</td>                                             
                                                <td style="width: 8%;">1-09-2016</td>                                   
                                                <td style="width: 8%;">1-20-2016 </td>  
                                                <td style="width: 10%">86744 647 2327</td>
                                                <td style="width: 8%">1-22-2016</td>                                
                                            ...
                                            <tr>                                 
                                               <td style="width: 2%;"><input type="checkbox" class="flat-red"></td>
                                                <td style="width: 13%;">WPS Health Insurance</td>                                             
                                                <td style="width: 8%;">1-09-2016</td>                                   
                                                <td style="width: 8%;">1-20-2016 </td>  
                                                <td style="width: 10%">86744 647 2327</td>
                                                <td style="width: 8%">1-22-2016</td>                                
                                            ...
                                            <tr>                                 
                                                <td style="width: 2%;"><input type="checkbox" class="flat-red"></td>
                                                <td style="width: 13%;">Baker, Russell S</td>                                             
                                                <td style="width: 8%;">1-09-2016</td>                                   
                                                <td style="width: 8%;">1-20-2016 </td>  
                                                <td style="width: 10%">86744 647 2327</td>
                                                <td style="width: 8%">1-22-2016</td>                                
                     ...
                     <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 no-padding" style="background: #f7fce6;  border-left: 1px solid #9aebc4;"><!--  2nd Content Starts -->
                      
                        <div class="box-body form-horizontal js-address-class" id="js-address-primary-address">


                            
                            <h4 class="no-padding med-green" style="margin-bottom: 7px; font-size: 14px; margin-top:3px;">
                                Heading
                            </h4>
                            ...
                            <div class="form-group-billing" style="margin-bottom: -20px;">
                                {!! Form::label('pos', 'Employer',  ['class'=>'col-lg-4 col-md-4 col-sm-4 col-xs-12 control-label-billing med-green']) !!} 
                                <div class="col-lg-7 col-md-7 col-sm-7 col-xs-10 billing-select2-disabled-green">
                                    {!! Form::select('insurance_id', array(''=>'-- Select --')+(array)$insurances,  $insurance_id,['class'=>'select2 form-control']) !!}
                                </div> 
                ...
                <li class="billing-grid">
                    <table class="table-billing-view" style="width: 100%;">
                        <thead>
                            <tr>
                                <th style="text-align: center; width: 3%;">&emsp;</th>
                                <th style="text-align: center; width: 13%;">Transaction</th>                                                
                                ...
                                <th style="text-align: center; width: 10%">Denial Code</th>
