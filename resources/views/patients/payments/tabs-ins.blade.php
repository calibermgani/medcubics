        ...
        <div class="box-body" style=" border-radius: 4px;">
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 billing-create-tab-b m-b-m-8">               
               <?php
                ...
                <p style="margin-top:5px;"><span class="med-orange sm-size"><i class="med-orange med-gender fa @if(@$patients->gender == 'Male') fa-male @else fa-female @endif margin-r-5 "></i> @if(@$patient_detail->dob != "0000-00-00" && @$patient_detail->dob != "1901-01-01" && @$patient_detail->dob != ""){{ App\Http\Helpers\Helpers::dateFormat(@$patient_detail->dob,'dob').", "}}{{ App\Http\Helpers\Helpers::dob_age(@$patient_detail->dob) }} @else @endif </span></p>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12  tab-l-b-1 m-b-m-8 tab-t-10">
                ...
                <p  class="space-m-t-7"><span class="font600 med-green">Claim Type </span> &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; : 
                <span><i class="fa fa-tv"></i> Electronic </span></p>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 m-b-m-8  tab-l-b-3 md-display">
                ...
                <p class="space-m-t-7"><span class="med-green font600">Created Date </span> <span class="pull-right font12 font600 bg-date">May 23,2015</span></p>
                ...
                <p class="space-m-t-7"><span class="med-green font600">Last Submitted Date </span> <span class="pull-right font12 font600 bg-date">Feb 16, 2015</span></p>
            </div>
        </div><!-- /.box-body -->
    </div><!-- /.box -->
</div>