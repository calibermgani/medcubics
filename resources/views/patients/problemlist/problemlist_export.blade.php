...
<html lang="en">
    <head>
        <title>Patient - Workbench List</title>
        <style>
            table tbody tr  td{
    ...
    <body>
        ...
        <table>
            ...
            <tr>
                <td colspan="15" style="text-align:center;">Patient Workbench list</td>
            </tr>
            <tr>
                <td colspan="15" style="text-align:center;"><span>User :</span><span>{{ Auth::user()->name }}</span> | <span>Created :</span><span>{{ App\Http\Helpers\Helpers::timezone(date("m/d/y H:i:s"), 'm/d/y') }}</span></td>
            </tr>
        </table>
        <table>
            <thead>
            ...
            <tbody>
                ...
                @if(isset($last_addin_problemlist) && !empty($last_addin_problemlist))
