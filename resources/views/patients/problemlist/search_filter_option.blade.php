{!! Form::open(['url'=>'patients/'.$patient_id.'/problemlist/type','id'=>'js_common_search_form','name'=>'search_form']) !!}
<?php 
	$value =  App\Models\Payments\ClaimInfoV1::getSearchCriteria($patient_id);
...
<div id="js_claim_search_option">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 margin-t-10">
        <div class="no-shadow form-horizontal">
            ...
            <div class="form-group-billing">
                {!! Form::label('Claim No', 'Claim No',  ['class'=>'col-lg-3 col-md-4 col-sm-4 col-xs-12 control-label']) !!}
                <div class="col-lg-7 col-md-7 col-sm-6 col-xs-10 select2-white-popup">
            ...
            <div class="form-group-billing js-select-div" id = "js-select-main">
                ...
                <div class="col-lg-5 col-md-3 col-sm-3 col-xs-10 select2-white-popup">
                    {!! Form::select('billed_option', array(''=>'-- Select --','lesshan'=>'<', 'lessequal'=>'<=','equal'=>'=','greaterthan'=>'>','greaterequal'=>'>='),  null,['class'=>'form-control input-view-border1 select2 js_main_select']) !!}
                </div>               
                <div class="col-lg-4 col-md-3 col-sm-3 col-xs-10">
                    {!! Form::text('billed',null,['maxlength'=>'26','class'=>'form-control dm-copay-amount input-sm-header-billing js_sub_select','placeholder'=>'Amount']) !!}
                </div>
            </div>
             <div class="form-group-billing js-select-div" id = "js-select-main-balance">
                {!! Form::label('Balance Amount', 'Balance Amt',  ['class'=>'col-lg-3 col-md-4 col-sm-4 col-xs-12 control-label']) !!} 
                <div class="col-lg-5 col-md-3 col-sm-3 col-xs-10 select2-white-popup">
                    {!! Form::select('balance_option', array(''=>'-- Select --','lessthan'=>'<','lessequal'=>'<=','equal'=>'=','greaterthan'=>'>','greaterequal'=>'>='),  null,['class'=>'form-control input-view-border1 select2 js_main_select']) !!}
                </div>
               
                <div class="col-lg-4 col-md-3 col-sm-3 col-xs-10">
                    {!! Form::text('balance',null,['maxlength'=>'26','class'=>'form-control dm-copay-amount input-sm-header-billing js_sub_select','placeholder'=>'Amount']) !!}
                </div>
            </div>
            <div id="js_search_date_adj" class="js_date_validation form-group-billing">
                {!! Form::label('DOS', 'Followup date',  ['class'=>'col-lg-3 col-md-4 col-sm-4 col-xs-12 control-label']) !!}
                <div class="col-lg-5 col-md-3 col-sm-3 col-xs-10">
                    ...
                    {!! Form::text('follow_from',null,['id'=>'dos_from','class'=>'form-control input-sm-header-billing dm-date datepicker search_start_date','placeholder'=>'From']) !!}
                </div>
                <div class="col-lg-4 col-md-3 col-sm-3 col-xs-10">
                    <i class="fa {{Config::get('cssconfigs.common.calendar')}} form-icon-billing med-gray"></i>
                    {!! Form::text('follow_to',null,['id'=>'dos_to','class'=>'form-control input-sm-header-billing dm-date datepicker search_end_date','placeholder'=>'To']) !!}
                </div>
            </div>
