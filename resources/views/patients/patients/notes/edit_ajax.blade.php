    ...
    <div class="box-body form-horizontal no-padding">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 no-padding ">
            <div class="box box-view no-shadow no-padding yes-border no-bottom">
				...
				{!! Form::model($notes, ['method'=>'PATCH','id'=>'js-bootstrap-validator', 'url'=>'patients/'.$type_detailsID.'/notes/'.$notesID,'name'=>'medcubicsform','class'=>'medcubicsform js-submit-popupform-notes']) !!}
