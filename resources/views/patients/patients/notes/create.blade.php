...
<div class="row toolbar-header">
    ...
    <section class="content-header">
        <h1>
            <small class="toolbar-heading"><i class="fa fa-sticky-note font14"></i> Notes <i class="fa fa-angle-double-right med-breadcrum" data-name="angle-wide-right"></i> <span>New</span></small>
        </h1>
        <ol class="breadcrumb">
...
@section('practice')
{!! Form::open(['url'=>'patients/'.$patients->id.'/notes','id'=>'js-bootstrap-validator','name'=>'medcubicsform','class'=>'medcubicsform']) !!}
