...
<div class="row toolbar-header">
    <section class="content-header">
        <h1>
            <small class="toolbar-heading"><i class="fa {{Config::get('cssconfigs.Practicesmaster.ar')}}"></i> Followup List </small>
        </h1>
        <ol class="breadcrumb">			
            <?php $uniquepatientid = $id; ?>				
            <li><a href={{App\Http\Helpers\Helpers::patientBackButton($uniquepatientid)}} class="js_next_process"><i class="fa {{Config::get('cssconfigs.common.back')}}" data-placement="bottom"  data-toggle="tooltip" data-original-title="Back"></i></a></li>		
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-10 select2-white-popup">       
                                        {!! Form::select('user_id', [''=>'-- Assigned To --']+(array)$user_list,Auth::user()->id,['class'=>'select2 form-control js_indivual_assign_to','id'=>'js_indivual_assign_user_id_'.@$claim_detail_val->claim_number]) !!}
                                    </div>                                        
                                </div>  
                            </div>
                        </div>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 no-padding yes-border tabs-border margin-t-10">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 margin-t-10 margin-b-5">
                                            ...
                                            <div class="form-group-billing">
                                                {!! Form::label($qsublist->question.'_label', $count .".". $qsublist->question, ['class'=>'col-lg-6 col-md-6 col-sm-6 col-xs-12 control-label-billing med-green ']) !!}
                                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-10">
                                                    {!! Form::text($qlist->label_name.'~~'.$qsublist->question_label, null,['class'=>'common_error_validate form-control input-sm-header-billing @if($qsublist->hint == 'Check no') js-all-caps-letter-format @endif ','data-field-type'=>$qsublist->field_validation]) !!}
                                                </div>
                                            </div>
