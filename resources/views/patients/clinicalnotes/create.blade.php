...
<div class="row toolbar-header">
   ...
   <section class="content-header">
        <h1>
            <small class="toolbar-heading"><i class="fa {{Config::get('cssconfigs.Practicesmaster.notes')}} font14"></i> Clinical Notes <i class="fa fa-angle-double-right med-breadcrum" data-name="angle-wide-right"></i><span> New Clinical Note</span></small>
        </h1>
        <ol class="breadcrumb">
...
@section('practice')
	...
	{!! Form::open(['url'=>'patients/'.$patient_id.'/clinicalnotes','id'=>'js-bootstrap-validator','files'=>true,'method'=>'POST','name'=>'medcubicsform','class'=>'medcubicsform','data-id'=>$patient_id,'data-page'=>"create"]) !!}
