...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    ...
    <div class="med-tab nav-tabs-custom margin-t-m-13 no-bottom">
        <ul class="nav nav-tabs">
            <li class="@if($activetab == 'payments_list') active @endif"><a href="{{ url('patients/'.$id.'/armanagement1/armanagement') }}" ><i class="fa fa-cog i-font-tabs"></i> Financials</a></li>           	                      	           
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 margin-b-10 margin-t-10">
                <div class="payment-links pull-right">
                    <ul class="nav nav-pills">
                        <li><a data-toggle="modal" data-target="#eligibility_details"><i class="fa fa-check-square-o"></i> Eligibility</a></li>
                        <li><a ><i class="fa fa-folder-open"></i> Documents</a></li>
                        <li class="dropdown">
                            <a class="dropdown-toggle med-orange" data-toggle="dropdown" href="#">More <b class="caret"></b></a>
                            <ul class="dropdown-menu" style="margin-left:-70px;">                            
                                <li class="form-cursor"><a data-toggle="modal" data-target="#billing1"><i class="fa fa-pencil"></i> Edit Charge</a></li>
                                <li><a><i class="fa fa-money"></i> Edit Payment</a></li>
                                <li class="form-cursor"><a data-toggle="modal" data-target="#billing_details"> <i class="fa fa-file-text"></i> Billing Details</a></li>
                            </ul>
                        </li>                    
                    </ul>
                </div>
                    ...
                    <div class=" box-view no-shadow tabs-border border-radius-4 no-bottom"><!-- VOB Box starts -->
                        ...
                        <div class="box-body margin-t-m-5"><!-- Notes Box Body starts -->
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 table-responsive margin-t-5 p-b-5 left-border">                                                        
                                <p class="no-bottom font600 form-cursor"><a data-toggle="modal" data-target="#denial_details"><i class="fa fa-denials"></i> Denials</a></p>
                                <p class="no-bottom margin-t-5 font600 form-cursor"><a data-toggle="modal" data-target="#followup_details"><i class="fa fa-calendar"></i> Followup Template</a></p>
                                <p class="no-bottom margin-t-5 font600 form-cursor"><a><i class="fa fa-volume-down"></i> Voice</a></p>
                                <p class="no-bottom margin-t-5 font600 form-cursor"><a data-toggle="modal" data-target="#assign"><i class="fa fa-user"></i> Assign To</a></p>
                            </div>
                        </div><!-- Notes box-body Ends-->
                    </div><!-- Notes box Ends -->           
                </div><!-- Notes COl Ends -->  
                        ...
                        <div class="box-body form-horizontal">
                                    ...
                                    <div class="box no-border  no-shadow"><!-- Box Starts -->
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 tab-r-b-1 border-green"><!--  1st Content Starts -->
                                            ...
                                            <div class="box-body form-horizontal"><!-- Box Body Starts -->
                                                ...
                                                <div class="form-group-billing"> 
                                                    {!! Form::label('authorization', 'Auth #', ['class'=>'col-lg-5 col-md-5 col-sm-4 col-xs-12 control-label-billing med-green']) !!}
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" ><!--  2nd Content Starts -->
                                            ...
                                            <div class="box-body form-horizontal js-address-class" id="js-address-primary-address">                         
                                                ...
                                                <div class="form-group-billing">                             
                                                    {!! Form::label('Admit', 'Admit', ['class'=>'col-lg-3 col-md-3 col-sm-4 col-xs-12 control-label-billing  med-green']) !!}
                            ...
                            <div class="box-footer space20">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    @if(!empty($claims) && $claims->status = 'Ready to submit')
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 no-padding yes-border tabs-border margin-t-5">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 table-responsive margin-b-10">
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 form-horizontal">
                                    <div class="form-group-billing">
                                        {!! Form::label('Billed To', 'Insurance', ['class'=>'col-lg-5 col-md-5 col-sm-4 col-xs-12 control-label-billing med-green font600']) !!}
                                        <div class="col-lg-7 col-md-7 col-sm-7 col-xs-10 select2-white-popup">  </div>                                                                
                                    </div>
                                    <div class="form-group-billing">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 med-bg-f0f0f0"><!--  1st Content Starts -->
                                            ...
                                            <div class="box-body form-horizontal no-padding"><!-- Box Body Starts --> 
                                                ...
                                                <div class="form-group-billing">
                                                    ...
                                                    <div class="col-lg-7 col-md-7 col-sm-6 col-xs-10">     
                                                        <i class="fa fa-calendar-o form-icon-billing font12"></i>
                            ...
                            <table id="example2" class="table table-bordered table-striped ">         
                                ...
                                <tbody>
                                    <tr class="clsCursor">
                                        ...
                                        <td>Cigna Health Care</td>
                                        <td>06/23/1978</td>        
                                        <td><a target = "_blank" href= "" data-toggle="tooltip" data-original-title="View more" data-placement="bottom"><i class="fa fa-file-text"></i></a></td> 
                                        <td><a target = "_blank" href= "" data-toggle="tooltip" data-original-title="View more" data-placement="bottom"><i class="fa fa-file-text"></i></a></td> 
                                    </tr>                    
                                </tbody>
                            </table>
