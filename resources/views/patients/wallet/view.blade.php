...
@include ('patients/armanagement/tabs')
@stop
...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    ...
    <div class="med-tab nav-tabs-custom margin-t-m-13 no-bottom">
        <ul class="nav nav-tabs">
            <li class="@if($activetab == 'payments_list') active @endif"><a href="{{ url('patients/'.$id.'/armanagement') }}" ><i class="fa fa-cog i-font-tabs"></i> Financials</a></li>           	                      	           
            <li class="@if($activetab == 'list') active @endif"><a href="{{ url('patients/'.$id.'/list') }}" ><i class="fa fa-navicon i-font-tabs"></i> Lists</a></li>           	                      	           
            <li class="@if($activetab == 'view') active @endif"><a href="" ><i class="fa fa-navicon i-font-tabs"></i> View</a></li>           	                      	           
        </ul>
    </div>
    <!-- Tab Ends -->
    ...
    <div class="box box-view no-shadow no-border"><!--  Box Starts -->
        <div class="box-body form-horizontal">        
            ...
            <div class="payment-links pull-right no-bottom margin-t-m-5">
                <ul class="nav nav-pills">
                    <li><a><i class="fa fa-user"></i> Eligibility</a></li>
                    <li><a data-toggle="modal" data-target="#notes_details"><i class="fa fa-folder-open"></i> Documents</a></li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" style="margin-left:-70px;">                            
                            <li><a data-toggle="modal" data-target="#billing1"><i class="fa fa-pencil"></i> Edit Charge</a></li>
                            <li><a><i class="fa fa-money"></i> Edit Payment</a></li>
                            <li><a data-toggle="modal" data-target="#billing_details"> <i class="fa fa-file-text"></i> Billing Details</a></li>
                        </ul>
                    </li>                    
                </ul>
            </div>
			
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 no-padding yes-border margin-t-5 tabs-border border-radius-4">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 no-padding margin-t-m-10">
                    <span class="bg-white med-orange padding-0-4 font13 margin-l-10"> Claim Details</span>
                </div>
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 table-responsive" >
                        ...
                        <table class="popup-table-claims table">                    
                            <tbody>
                                <tr class="tab-r-b-1 green-b-c">
                                    <td class="font600"><span class="med-red">Rend Prov</span></td>
                                    <td>John, Miller</td>                                  
                                </tr>
                                <tr class="tab-r-b-1 green-b-c">
                                    ...
                                    <td>
                                        <div class="form-group-billing">                            
                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9">
                                                {!! Form::text('icd1','Correy Willamson',['class'=>'form-control input-charge-view']) !!}
                                            </div>                                                     
                                        </div>
                                    </td>  
                                </tr>
                                <tr class="tab-r-b-1 green-b-c">
                                    ...
                                    <td>
                                        <div class="form-group-billing">                            
                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9">
                                                {!! Form::text('icd1','John, Miller',['class'=>'form-control input-charge-view']) !!}
                                            </div>                                                     
                                        </div>
                                    </td>                                
                                </tr>
                                ...
                                <tr class="tab-r-b-1 green-b-c">
                                    ...
                                    <td>
                                        <div class="form-group-billing">                            
                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9">
                                                {!! Form::text('icd1','NJ Clinic',['class'=>'form-control input-charge-view']) !!}
                                            </div>                                                     
                                        </div>
                                    </td>                                 
                                </tr>  
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 table-responsive" >
                        <table class="popup-table-claims table">                    
                            <tbody>
                                <tr class="tab-r-b-1 green-b-c">
                                    <td class="font600"><span class="med-red">POS</span></td>
                                    <td>Ambulance</td>                                  
                                </tr>
                                <tr class="tab-r-b-1 green-b-c">
                                    ...
                                    <td>
                                        <div class="form-group-billing">                               
                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9 billing-select2-claim-view @if($errors->first('rendering_provider_id')) error @endif">
                                ...
                                <tr class="tab-r-b-1 green-b-c">
                                    <td class="font600"><span class="med-red">Claim No</span></td>
                                    <td>
                                        <div class="form-group-billing">                            
                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9">
                                                {!! Form::text('icd1','Ebill4t1',['class'=>'form-control input-charge-view']) !!}
                                            </div>                                                     
                                        </div>
                                    </td>                                
                                </tr>  
                                <tr class="tab-r-b-1 green-b-c">
                                    ...
                                    <td>
                                        <div class="form-group-billing">                            
                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9">
                                                {!! Form::text('icd1','Electronic',['class'=>'form-control input-charge-view']) !!}
                                            </div>                                                     
                                        </div>
                                    </td> 
            ...
            <div class="payment-links pull-right margin-t-20">              
                ...
                <ul class="nav nav-pills">
                    <li><a data-toggle="modal" data-target="#assigned_details"> <i class="fa fa-user"></i> Assigned To</a></li>                    
                    <li><a data-toggle="modal" data-target="#payment_details"> <i class="fa fa-file-text-o"></i> View Transaction</a></li>
                    <li><a data-toggle="collapse" data-target="#notes"> <i class="fa fa-sticky-note"></i> Notes & Workbench</a></li>                                                           
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href=""><i class="fa fa-picture-o"></i> CMS 1500</a></li>
                            <li><a href=""><i class="fa fa-file-text-o"></i> Statement</a></li>
                        </ul>
                    </li>
                    <li><a><i class="fa fa-fax"></i> Fax</a></li>
                    <li><a><i class="fa fa-check"></i> Submit</a></li>
                    <li><a><i class="fa fa-exclamation-triangle"></i> Hold</a></li>
                </ul>
            </div>
            
            <div class="collapse out" id = "notes">
            <div  class=" col-lg-7 col-md-7 col-sm-12 col-xs-12 margin-t-20 no-padding"><!-- Notes Col starts -->
                
                <div class="box box-view no-shadow tabs-border "><!-- VOB Box starts -->
                    ...
                    <div class="box-header-view bg-white no-border-radius yes-border green-b-c no-b-l no-b-r">                                                                        
                        <div class="payment-links pull-right">
                            <ul class="nav nav-pills ">
                                <li><a data-toggle="modal" data-target="#denial_details"><i class="fa fa-plus"></i>Denials</a></li>
                                <li><a><i class="fa fa-volume-down"></i> Voice</a></li>
                                <li><a <a data-toggle="modal" data-target="#followup_details"><i class="fa fa-edit"></i> Followup</a></li> 
                                <li><a data-toggle="modal" data-target="#template_details"><i class="fa fa-edit"></i> Template</a></li> 
                                <li><a data-toggle="modal" data-target="#full-notes"><i class="fa fa-arrows-alt"></i> Full View</a></li>                   
                            </ul>
                        </div>
                    </div><!-- /.box-header -->
                    <div class="box-body  margin-t-m-5"><!-- Notes Box Body starts -->
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 table-responsive margin-t-5 p-b-5">

                            
                            
                            <div class="form-group-billing">
                                
                                <div class="col-lg-11 col-md-6 col-sm-6 col-xs-10 select2-white-popup p-r-0">                                    
                                    {!! Form::textarea('insurance',null,['class'=>'form-control ar-notes-minheight','placeholder'=>'Type your Notes']) !!}
                                </div>
                                <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1 ">
                                    <p class="text-center"><i class="fa fa-play-circle font30 med-orange"></i></p>
                                </div>
                            </div>
                        </div>
            ...
            <div  class=" col-lg-5 col-md-5 col-sm-12 col-xs-12 margin-t-20 p-r-0"><!-- Notes Col starts -->
                <div class="box box-view no-shadow tabs-border"><!-- VOB Box starts -->
                     <p class="med-orange no-bottom  font13 margin-l-10 margin-t-m-10"> <span class="bg-white padding-0-4 font600 ">Workbench</span></p>
              
                    <div class="box-body margin-t-m-5 chat ar-notes border-bottom-dotted green-b-c"><!-- Notes Box Body starts -->
                        
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 table-responsive border-bottom-dotted margin-t-5 p-b-5">
                            <p class="no-bottom font600"><span class="med-green">John Miller</span><span class="pull-right font12"><span class=" med-gray-dark"><i class="fa fa-calendar-o"></i> 12 May 2016</span></span></p>
                            Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum is simply dummy text of the printing and typesetting industry.                       
                         <p class="no-bottom font600">Assigned :<span class="med-green"> David Miller</span><span class="pull-right font12"><span class=" med-red"> High</span> 
                        </div>
                        
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 table-responsive border-bottom-dotted margin-t-5 p-b-5">
                            <p class="no-bottom font600"><span class="med-green">David Hussey</span><span class="pull-right font12"><span class=" med-gray-dark"><i class="fa fa-calendar-o"></i> 12 May 2016</span></span></p>
                            Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum is simply dummy text of the printing and typesetting industry.                       
                         <p class="no-bottom font600">Assigned :<span class="med-green"> David Miller</span><span class="pull-right font12"><span class=" med-green-o"> Low</span> 
                        </div>
                                    
                    </div><!-- Notes box-body Ends-->
                    
                    <div class="box-body table-responsive"><!-- Notes Box Body starts -->
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p-b-5">                           
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 no-padding">
                                <div class="form-group-billing">                                
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 select2-white-popup">                                    
										{!! Form::textarea('insurance',null,['class'=>'form-control minheight-50','placeholder'=>'Type your Notes']) !!}
									</div>                               
								</div>
                            </div>
                            <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10 no-padding">
								<div class="form-group-billing">                                                  
									<div class="col-lg-5 col-md-5 col-sm-5 col-xs-12 select2-white-popup">                                    
										{!! Form::select('insurance', [''=>'-- Assigned To --','Paid' => 'User 1','Cash' => 'User 2','ppaid'=>'User 3'],null,['class'=>'select2 form-control']) !!}
									</div>  
									<div class="col-lg-1 col-md-1 col-sm-1 col-xs-1"></div>
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 select2-white-popup">                                    
										<i class="fa fa-calendar-o form-icon-billing"></i>
										{!! Form::text('insurance',null,['class'=>' form-control input-sm-header-billing','placeholder'=>'Followup Date']) !!}
									</div>  
								</div>                                
                            </div>
                            ...
                            <div class="form-group-billing">                                                  
                                <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12 select2-white-popup">
                                    {!! Form::select('insurance', [''=>'-- Priority --','High' => 'High','Cash' => 'Moderate','paid'=>'Low'],null,['class'=>'select2 form-control']) !!}
                                </div>   
                                <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1"></div>
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 select2-white-popup">                                    
                                   {!! Form::select('insurance', [''=>'-- Status --','Assigned' => 'Assigned','Inprocess' => 'Inprocess','Completed'=>'Completed'],null,['class'=>'select2 form-control']) !!}
                                </div>  
                            </div>
                            ...
                            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
                            	{!! Form::submit('Save', ['class'=>'btn btn-medcubics-small pull-right margin-t-m-10 padding-2-8']) !!}
                            </div>
                        </div>
                    </div><!-- Notes box-body Ends-->
                </div><!-- Notes box Ends -->           
                ...
                <div class="modal-body no-padding" >
                    <div class="box box-view no-shadow no-border"><!--  Box Starts -->
                        <div class="box-body form-horizontal">
                                            ...
                                            <div class="box-body form-horizontal"><!-- Box Body Starts -->
                                                ...
                                                <div class="form-group-billing">
                                                    ...
                                                    <div class="col-lg-7 col-md-7 col-sm-7 col-xs-10 billing-select2 @if($errors->first('referring_provider_id')) error @endif">
                                                        {!! Form::text('refering_provider', @$claims->refering_provider->provider_name,['class'=>'form-control input-sm-header-billing js-remove-err autocomplete-ajax', 'id' => 'js-refer-provider','data-url' => 'api/getreferringprovider/provider']) !!} 
                            ...
                            <div id="js-count-icd">
                                <!-- Display ICD orders from E-superbill -->          
                                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12  yes-border no-b-t no-b-r border-green"><!-- ICD Details Starts here -->
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 med-orange no-padding margin-t-m-10 margin-b-5">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 yes-border no-b-t no-b-l no-b-r border-green">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 yes-border no-b-l no-b-t no-b-r border-green">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 yes-border no-b-l no-b-t border-green"><!-- ICD Details Starts here -->
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 med-orange no-padding margin-t-m-10">
                                        <span class="font600">&emsp;</span>
                                    </div>
                                    <div class="box-body form-horizontal">
                                            ...
                                            <table class="table-billing-view superbill-claim">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="td-c-6"><input type="text" maxlength = 6 class = "js-charge form-control input-sm-header-billing billing-noborder" id= "charge_<?php echo $i ?>" 
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 space10 no-padding">
                                <div class="payment-links">
									<ul class="nav nav-pills pull-left">
										<li><a href="#js-model-popup" data-toggle="modal" data-target="#js-model-popup" class="claimdetail font600" data-url=""> <i class="fa fa-file-text-o"></i> Claim Details</a></li>
										<li><a href="#js-model-popup" data-toggle="modal" data-target="#js-model-popup" class=" claimbilling font600" data-url=""> <i class="fa fa-ambulance"></i>Ambulance Billing</a></li> 
										<li><a href="#js-model-popup" data-toggle="modal" data-target="#js-model-popup" class=" claimotherdetail font600" data-url=""> <i class="fa fa-hand-o-right"></i> Other Details</a></li>                     
									</ul>                                
									...
									<ul class="nav nav-pills  pull-right">
										@if(count(explode(',', $claims->cmsform))>1)
										<li><a class="claimdetail font600"  onClick="window.open('{{ url('getcms/'.$id.'/1') }}', '_blank')"> <i class="fa fa-file-pdf-o"></i> CMS 1500</a></li>
										<li><a class=" claimbilling font600"  onClick="window.open('{{ url('getcms/'.$id.'/2') }}', '_blank')"> <i class="fa fa-file-pdf-o"></i> CMS 1500</a></li> 
										 @else  
										<li><a class=" claimotherdetail font600"  onClick="window.open('{{ url('getcms/'.$id) }}', '_blank')"> <i class="fa fa-file-pdf-o"></i> CMS 1500</a></li> 
										@endif  
										<li><a href="#" data-toggle="modal" data-target="#" class=" claimotherdetail font600" data-url=""> <i class="fa fa-reorder"></i> Workbench</a></li> 
									</ul>            
									@endif
								</div>            
                            </div>
                ...
                <div class="box box-view no-shadow no-border"><!--  Box Starts -->
                    ...
                    <div class="box-header-view bg-white  margin-t-10">                                                                        
                        <div class="input-group input-group-sm">
                            <input name="denial" type="text" class="form-control" style="border-color:#f0f0f0" placeholder="Search Denial Codes">
                    ...
                    <div class="box-header-view bg-white ar-bottom-border text-center">                                                                        
                       {!! Form::submit('Save', ['class'=>'btn btn-medcubics-small padding-2-8']) !!}
                       {!! Form::submit('Cancel', ['class'=>'btn btn-medcubics-small padding-2-8']) !!}
                    </div><!-- /.box-header -->
...
<!-- Modal PAyment details starts here -->
<div id="template_details" class="modal fade in">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body no-padding" >
                <div class="box box-view no-shadow no-border"><!--  Box Starts -->                                                                                                                                           
                    <div class="box-header-view bg-white  margin-t-10">                                                                        
                        <div class="input-group input-group-sm">
                            <input name="denial" type="text" class="form-control" style="border-color:#f0f0f0" placeholder="Search ...">
                            <span class="input-group-btn">
                                <button class="btn btn-flat btn-medgreen" type="button">Search</button>
                            </span>
                        </div>   
                        ...
                        <ul class="cpt-grid no-padding line-height-26 no-bottom" style="list-style-type:none;" id="">
                            <li class="denials">
                                <table class="table-striped-view">
                                    <tbody>
                                        <tr>
                                            <td class="padding-0-4 td-c-2">                                               
                                                <input type="checkbox" class="flat-red">
                                            </td>                                                
                                            <td style="width: 97%;"><span class="med-gray-dark">Patient refund amount.</span></td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="med-gray-dark">Medicare Claim PPS Capital Cost Outlier Amount.</span></td>
                                        </tr>
                                        <tr>
                                            <td class="padding-0-4">                                               
                                               <input type="checkbox" class="flat-red">
                                            </td>                                                 
                                            <td><span class="med-gray-dark">Prior hospitalization</span></td>
                                        </tr>
                                        <tr>
                                            <td class="padding-0-4">                                               
                                               <input type="checkbox" class="flat-red">
                                            </td>                                                
                                            <td><span class="med-gray-dark">Non-covered visits.</span></td>
                                        </tr>
                                        <tr>
                                            <td class="padding-0-4">                                               
                                               <input type="checkbox" class="flat-red">
                                            </td>                                               
                                            <td><span class="med-gray-dark">Previously paid. </span></td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="med-gray-dark">Workers' Compensation Medical Treatment Guideline Adjustment</span></td>
                                        </tr>
                                        <tr>
                                            <td class="padding-0-4">                                               
                                               <input type="checkbox" class="flat-red">
                                            </td>                                               
                                            <td><span class="med-gray-dark">Missing/incomplete of x-ray availability for review.</span></td>
                                        </tr>
                                        <tr>
                                            <td class="padding-0-4">                                               
                                               <input type="checkbox" class="flat-red">
                                            </td>                                              
                                            <td><span class="med-gray-dark">Missing pacemaker registration form.</span></td>
                                        </tr>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 no-padding yes-border tabs-border margin-t-10">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 margin-t-10">
                                            ...
                                            <div class="form-group-billing">                                               
                                                ...
                                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                    <span class="med-orange font600 pull-right margin-r-5"><i class="fa fa-plus-circle"></i> Add New</span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12  margin-b-5">                                                                                        
                                            <ul style="list-style-type:none; margin-left:-40px;">
                                                ...
                                                <li><label><input type="radio" name="status" value=""> Ready to Submit</label></li>
...
<!-- Modal PAyment details starts here -->
<div id="assigned_details" class="modal fade in">
    <div class="modal-sm-usps">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">Assigned Info </h4>
            </div> 
            <div class="modal-body no-padding" >
                <div class="box box-view no-shadow no-border"><!--  Box Starts -->                                                                                                                                                               
                    
                    <div class="box-body"><!-- Notes Box Body starts -->
                        
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 table-responsive margin-t-5 p-b-5 form-horizontal">

                            
                            <div class="form-group-billing">
                                {!! Form::label('Unapplied', 'Assigned To', ['class'=>'col-lg-6 col-md-6 col-sm-6 col-xs-12 control-label-billing med-green font600']) !!}                                                  
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-10 select2-white-popup">                                    
                                    {!! Form::select('insurance', [''=>'-- Select --','Paid' => 'User 1','Cash' => 'User 2','ppaid'=>'User 3'],null,['class'=>'select2 form-control']) !!}
                                </div>                                   
                            </div>
                            <div class="form-group-billing">
                                {!! Form::label('Unapplied', 'Caller', ['class'=>'col-lg-6 col-md-6 col-sm-6 col-xs-12 control-label-billing med-green font600']) !!}                                                  
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-10 select2-white-popup">                                    
                                    {!! Form::select('insurance', [''=>'-- Select --','Paid' => 'Caller 1','Cash' => 'Caller 2','ppaid'=>'Caller 3'],null,['class'=>'select2 form-control']) !!}
                                </div>                                   
                            </div>
                            <div class="form-group-billing">
                                {!! Form::label('Unapplied', 'Callback', ['class'=>'col-lg-6 col-md-6 col-sm-6 col-xs-12 control-label-billing med-green font600']) !!}                                                  
                            ...
                            <div class="form-group-billing">
                                {!! Form::label('Priority', 'Priority', ['class'=>'col-lg-6 col-md-6 col-sm-6 col-xs-12 control-label-billing med-green font600']) !!}                                                  
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-10 select2-white-popup">                                    
                                    {!! Form::select('insurance', [''=>'-- Select --','High' => 'High','Cash' => 'Moderate','paid'=>'Low'],null,['class'=>'select2 form-control']) !!}
                                </div>                                   
                            </div>
                            {!! Form::submit('Save', ['class'=>'btn btn-medcubics-small pull-right','style'=>'padding:2px 16px;']) !!}
                        </div>                                                                     
                    </div><!-- Notes box-body Ends-->                    
...
<!-- Modal Payment Details ends here -->
 ...
 <!-- Modal PAyment details starts here -->
<div id="notes_details" class="modal fade in">
    <div class="modal-md-650">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            ...
            <div class="modal-body no-padding" >
               <div class="box box-view no-shadow no-border"><!-- VOB Box starts -->
                    ...
                    <div class="box-body table-responsive chat ar-notes margin-t-m-5"><!-- Notes Box Body starts -->
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 table-responsive border-bottom-dotted margin-t-5 p-b-5">

                            <p class="no-bottom font600"><span class="med-green">04-25-2015</span><span class="pull-right font12"><span class=" med-gray-dark "><i class="fa fa-user"></i> John Miller</span> | <span class=" med-orange"><i class="fa fa-calendar-o"></i> 12 May 2016</span></span></p>
                            Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap   Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap                                           

                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 table-responsive border-bottom-dotted margin-t-5 p-b-5">
                            <p class="no-bottom font600"><span class="med-green">10-16-2015</span><span class="pull-right font12"><span class=" med-gray-dark "><i class="fa fa-user"></i> George Bailey</span> | <span class=" med-orange"><i class="fa fa-calendar-o"></i> 23 Apr 2016</span></span></p>
                            Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap                                           
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 table-responsive border-bottom-dotted margin-t-5 p-b-5">
                            <p class="no-bottom font600"><span class="med-green">10-16-2015</span><span class="pull-right font12"><span class=" med-gray-dark "><i class="fa fa-user"></i> Correy Anderson</span> | <span class=" med-orange"><i class="fa fa-calendar-o"></i> 7 Apr 2016</span></span></p>
                            Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap                                           
                        </div>                                                
                    </div><!-- Notes box-body Ends-->
                    <div class="box-header-view bg-aqua ar-bottom-border">                                                                        
                        <div class="payment-links pull-right margin-t-5">
                            <ul class="nav nav-pills">
                                <li><a><i class="fa fa-plus"></i> Add Notes</a></li>
                                <li><a><i class="fa fa-volume-down"></i> Voice Notes</a></li>
                                <li><a><i class="fa fa-edit"></i> Template</a></li>
                                <li><a data-toggle="modal" data-target="#full-notes" ><i class="fa fa-arrows-alt"></i> Full View</a></li>                   
                            </ul>
                        </div>
                    </div><!-- /.box-header -->
                    <div class="box-body table-responsive  margin-t-m-5"><!-- Notes Box Body starts -->
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 table-responsive border-bottom-dotted margin-t-5 p-b-5">
                                                        
                            <div class="form-group-billing">
                                
                                <div class="col-lg-11 col-md-6 col-sm-6 col-xs-10 select2-white-popup p-r-0">                                    
                                    {!! Form::textarea('insurance',null,['class'=>'form-control']) !!}
                                </div>
                                <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1 ">
                                    <p class="text-center"><i class="fa fa-play-circle font26 med-orange font30"></i></p>
                                </div>
                            </div>
                        </div>
