...
<div class="row toolbar-header">
    <section class="content-header">
        <h1>
            <small class="toolbar-heading"><i class="fa {{Config::get('cssconfigs.Practicesmaster.ar')}}"></i> AR Management </small>
        </h1>
        <ol class="breadcrumb">
			 <?php $uniquepatientid = $id; ?>	
			<li><a accesskey="b" href={{App\Http\Helpers\Helpers::patientBackButton($id)}} class="js_next_process"><i class="fa {{Config::get('cssconfigs.common.back')}}" data-placement="bottom"  data-toggle="tooltip" data-original-title="Back"></i></a></li> 
...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    ...
    <div class="med-tab nav-tabs-custom margin-t-m-13 no-bottom">
        <ul class="nav nav-tabs">
            ...
            <li class="@if($activetab == 'list') active @endif"><a href="{{ url('patients/'.$id.'/armanagement/list') }}" ><i class="fa fa-navicon i-font-tabs"></i> Lists</a></li>           	                      	           
        </ul>
    </div>
    <!-- Tab Ends -->
                            ...
                            <div class="box box-view no-shadow no-border-radius" style="border-color: #ebe0c6"><!-- Red Alert Box Starts -->
                                ...
                                <div class="box-body table-responsive"><!-- Red Alert Box Body Starts -->
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 no-padding m-b-m-10">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 no-padding">
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 no-padding margin-t-m-10">
                                                <h6 class="med-green" style="">Auth No</h6>
                                            </div>
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 no-padding margin-t-m-10">
                                                <h6 class="">- Nil  -</h6>
                                            </div>
