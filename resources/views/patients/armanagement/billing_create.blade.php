                ...
                <div class="box no-border  no-shadow"><!-- Box Starts -->
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" ><!--  2nd Content Starts -->
                        ...
                        <div class="box-body form-horizontal js-address-class" id="js-address-primary-address">
                            ...
                            <div class="form-group-billing"> 
                                {!! Form::label('authorization', 'Auth No', ['class'=>'col-lg-5 col-md-5 col-sm-5 col-xs-12 control-label-billing med-green font600']) !!}                                                  
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-center" style="width: 8%;">
                                        <input type="text" id="<?php echo $i; ?>" readonly="readonly" class="js-cpt billing-noborder" value = "{{@$claims->dosdetails[$i]->cpt_code}}" name= <?php echo "cpt[" . $i . "]"; ?> >
                                    ...
                                    <td style="text-align: center; width: 6%"><input type="text" maxlength = 6 class = "js-charge form-control input-sm-header-billing billing-noborder" id= "charge_<?php echo $i ?>" name=<?php echo "charge[" . $i . "]"; ?> value = "{{@$claims->dosdetails[$i]->charge}}">
                        ...
                        <table class="table-billing-view superbill-claim">
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-center" style="width: 8%;">
                                        <input type="text" id="<?php echo $i; ?>" readonly="readonly" class="js-cpt billing-noborder" tabindex = -1 value = "<?php echo isset($cpt_codes[$i]) ? App\Models\Cpt::where('id', $cpt_codes[$i])->pluck('cpt_hcpcs') : ''; ?>" name= <?php echo "cpt[" . $i . "]"; ?> > 
                                        <input type="hidden" class="billing-noborder cpt_amt_<?php echo $i; ?>" value = "{{@$claims->dosdetails[$i]->charge}}" name="<?php echo "cpt_amt[" . $i . "]"; ?>"></td>
                                   ...
                                   <td class="text-center" style="width: 4%">{!! Form::text('modifier1['.$i.']',@$claims->dosdetails[$i]->modifier1,['class'=>'cpt_unit billing-noborder js-modifier', 'maxlength' => 2, 'id' =>'modifier1-'.$i]) !!}</td>
                                    ...
                                    <td style="text-align: center; width: 6%"><input type="text" class = "js-charge billing-noborder" maxlength = 6 id= "charge_<?php echo $i ?>" name=<?php echo "charge[" . $i . "]"; ?> value="<?php echo isset($cpt_codes[$i]) ? App\Models\Cpt::where('id', $cpt_codes[$i])->pluck('billed_amount') : ''; ?>">
