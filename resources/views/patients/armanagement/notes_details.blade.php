...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 no-padding table-responsive border-bottom-dotted margin-t-5 p-b-5">
    <p class="no-bottom font600">
        <span class="med-green font600">CN</span> - <span class="med-orange">{{App\Http\Helpers\Helpers::dateFormat(@$notes_detail->created_at,'datetime')}}</span>
        <span class="pull-right font12">
            <span class=" med-green">{{@$notes_detail->user->short_name }}</span>
        </span>
    </p>		
