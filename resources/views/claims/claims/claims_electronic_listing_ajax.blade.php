...
@endif
	...
	<td style="cursor:not-allowed;">
		{!! Form::checkbox("claim_ids[]",$claim_id,null,["class" => "no-margin js-select-all-sub-checkbox $class_name",'id'=>$key,"disabled" => "disabled"]) !!}<label for='{{$key}}' class="no-bottom">&nbsp;</label>
	</td>
	@else
	<td>
	...
	<td>{{ !empty($claim->filed_date)? App\Http\Helpers\Helpers::checkAndDisplayDateInInput(@$claim->filed_date,'','','m/d/y'):'-Nill-' }}</td>
	<td>
