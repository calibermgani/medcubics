...
<div class="row toolbar-header">
    <section class="content-header">
        <h1>
            <small class="toolbar-heading"><i class="fa {{Config::get('cssconfigs.common.calendar')}} med-breadcrum med-green"></i> @if(Request::segment(2) != 'myfollowup') AR Management @else Followup List @endif</small>
        </h1>
        <ol class="breadcrumb">                            
...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
	@include('armanagement/followuplist/tabs')
    <!-- Tab Starts  -->
    <div class="med-tab nav-tabs-custom  no-bottom js-dynamic-tab-menu">
        <ul class="nav nav-tabs">
            <li class="active"><a href="javascript:void(0);" ><i class="fa fa-bars i-font-tabs"></i><span id="claimdetlink_main0" class="js_claimdetlink"> List</span></a></li>             
        </ul>
    </div>
    <!-- Tab Ends -->
    <div id="js_artable_listing">
        @include('armanagement/followuplist/claimslist')
    </div>
</div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 no-padding yes-border tabs-border margin-t-5">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 table-responsive margin-b-10">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 form-horizontal">
                                ...
                                <div class="form-group">
                                    {!! Form::label('assigned_to', 'Assigned To', ['class'=>'col-lg-4 col-md-4 col-sm-4 col-xs-12 control-label-billing med-green font600 star','style'=>'padding-right: 0px; padding-left: 20px;']) !!} 
                                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-10 select2-white-popup">       
                                        {!! Form::select('user_id', [''=>'-- Select --']+(array)$user_list,null,['class'=>'select2 form-control js_indivual_assign_to','id'=>'js_indivual_assign_user_id_'.@$claim_detail_val->claim_number]) !!}
                                    </div>
                                </div>    
                            </div>
                        </div>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 margin-t-10 margin-b-5">
                                            ...
                                            <div class="form-group-billing {{ $qlist->name }}">
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-10">
                                                    ...
                                                    {!! Form::text($qlist->label_name.'~~'.$qsublist->question_label.' from',null,['class'=>'dm-date form-control input-sm-header-billing js_claim_status_popup_future_date common_error_validate','placeholder'=>'From','data-field-type'=>$qsublist->field_validation]) !!}
                                                </div>
                                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-10">
                                                    {!! Form::text($qlist->label_name.'~~'.$qsublist->question_label.' end', null,['class'=>'dm-date form-control input-sm-header-billing js_claim_status_popup_future_date common_error_validate','placeholder'=>'To','data-field-type'=>$qsublist->field_validation]) !!}
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group-billing">
                                                ...
                                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-10">
                                                    ...
                                                    {!! Form::text($qlist->label_name.'~~'.$qsublist->question_label, null,['class'=>'dm-date form-control input-sm-header-billing js_claim_status_popup_future_date common_error_validate','data-field-type'=>$qsublist->field_validation]) !!}
                                                </div>
                                            </div>
                                            @endif
                                            ...
                                            <div class="form-group-billing">
                                                {!! Form::label($qsublist->question.'_label', $count .".". $qsublist->question, ['class'=>'col-lg-6 col-md-6 col-sm-6 col-xs-12 control-label-billing med-green ']) !!} 
                                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-10">
                                                    {!! Form::text($qlist->label_name.'~~'.$qsublist->question_label, null,['class'=>'common_error_validate form-control input-sm-header-billing','data-field-type'=>$qsublist->field_validation]) !!}
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group-billing">
                                                {!! Form::label($qsublist->question.'_label', $count .".". $qsublist->question, ['class'=>'col-lg-6 col-md-6 col-sm-6 col-xs-12 control-label-billing med-green ']) !!}
                                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-10">
                                                    {!! Form::text($qlist->label_name.'~~'.$qsublist->question_label, null,['class'=>'form-control input-sm-header-billing common_error_validate','data-field-type'=>$qsublist->field_validation]) !!}
                                                </div>
                                            </div>
                                            @endif
                                                <?php $count++; ?>
