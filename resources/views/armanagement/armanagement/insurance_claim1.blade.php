...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 margin-t-20">
    ...
    <div class="med-tab nav-tabs-custom margin-t-m-13 no-bottom">
        <ul class="nav nav-tabs">
            ...
            <li class="@if($activetab == 'ins_claims') active @endif"><a href="{{ url('armanagement/insurance') }}" ><i class="fa fa-navicon i-font-tabs"></i> Insurance Wise</a></li>           	                      	           
