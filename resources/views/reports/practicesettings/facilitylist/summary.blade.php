    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="dropdown messages-menu hide js_claim_export">
                ...
                @include('layouts.practice_module_stream_export', ['url' => '/reports/filter_result_summary/export/'])
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 no-padding">
        <div class="box box-view no-shadow ">
            <div class="box-body yes-border border-green border-radius-4">
                {!! Form::open(['onsubmit'=>"event.preventDefault();",'id'=>'js-bootstrap-searchvalidator_edt', 'name'=>'medcubicsform', 'url'=>'reports/practicesettings/filter_result_summary', 'data-url'=>'reports/practicesettings/filter_result_summary']) !!}
...
<script type="text/javascript">
    ...
    var allcolumns = [];
    var listing_page_ajax_url = api_site_url+"/reports/practicesettings/filter_result_summary"; 
