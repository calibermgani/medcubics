...
<div class="row toolbar-header">
    <section class="content-header">
        <h1>
            <small class="toolbar-heading"><i class="livicon med-breadcrum" data-name="barchart"></i> Reports <i class="fa fa-angle-double-right med-breadcrum" data-name="angle-wide-right"></i> Financial Reports <i class="fa fa-angle-double-right med-breadcrum" data-name="angle-wide-right"></i> <span>Outstanding AR</span></small>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-horizontal no-padding js_search_part">
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            ...
                            <div class="form-group">
                                {!! Form::label('Group By', 'Group By', ['class'=>'col-lg-4 col-md-5 col-sm-4 col-xs-3 control-label']) !!}
                            ...
                            <div class="form-group">
                                {!! Form::label('Insurance Type', 'Insurance Type', ['class'=>'col-lg-4 col-md-5 col-sm-4 col-xs-3 control-label']) !!}
                                <div class="col-lg-7 col-md-6 col-sm-6 col-xs-9">
                            ...
                            <div class="form-group">
                                {!! Form::label('Billed To', 'Billed To', ['class'=>'col-lg-4 col-md-5 col-sm-4 col-xs-3 control-label']) !!}
                                <div class="col-lg-7 col-md-6 col-sm-6 col-xs-9">
                            ...
                            <div class="form-group">
                                {!! Form::label('Balance', 'Balance', ['class'=>'col-lg-4 col-md-5 col-sm-4 col-xs-3 control-label']) !!}
                                <div class="col-lg-7 col-md-6 col-sm-6 col-xs-9">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            ...
                            <div class="form-group">
                                {!! Form::label('Facility', 'Facility', ['class'=>'col-lg-4 col-md-5 col-sm-4 col-xs-3 control-label']) !!}
                                <div class="col-lg-7 col-md-7 col-sm-6 col-xs-9">
                            ...
                            <div class="form-group">
                                {!! Form::label('Rendering', 'Rendering', ['class'=>'col-lg-4 col-md-5 col-sm-4 col-xs-3 control-label']) !!}
                                <div class="col-lg-7 col-md-7 col-sm-6 col-xs-9">
