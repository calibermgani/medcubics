            ...
            <div class="box-body yes-border no-padding" style="border-color:#85E2E6;border-radius: 0px 0px 4px 4px;">          
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-horizontal no-padding reports-table js_search_part report-menu">
                    <table class="table no-bottom">
                        ...
                        <tbody>
                            <tr  data-url="{{ url('reports/adjustments') }}" class="js-table-click form-cursor">                                
                                <td class="font16">{!! HTML::image('img/r-2.png',null,['class'=>'margin-r-10']) !!} Appointment Analysis</td>
                                <td>12/12/2016</td>
                                <td><a href=""><i class="fa fa-angle-double-right font26"></i></a></td>                                
                            </tr>
                            
                            <tr  data-url="{{ url('reports/adjustments1') }}" class="js-table-click form-cursor">                              
                                <td class="font16 med-green">{!! HTML::image('img/r-2.png',null,['class'=>'margin-r-10']) !!} Appointment Detail Report</td>
                                <td>12/12/2016</td>
                                <td><a href=""><i class="fa fa-angle-double-right font26"></i></a></td>
                            ...
                            <tr>                                
                                <td class="font16">{!! HTML::image('img/r-2.png',null,['class'=>'margin-r-10']) !!} Appointment Status</td>
                                <td>12/12/2016</td>
                                <td><a href=""><i class="fa fa-angle-double-right font26"></i></a></td>
                            </tr>
                            
                            <tr>                               
                                <td class="font16 med-green">{!! HTML::image('img/r-2.png',null,['class'=>'margin-r-10']) !!} Cancelled Visits</td>
                                <td>12/12/2016</td>
                                <td><a href=""><i class="fa fa-angle-double-right font26"></i></a></td>
                            </tr>
                            
                            <tr>                               
                                <td class="font16">{!! HTML::image('img/r-2.png',null,['class'=>'margin-r-10']) !!} Encounter Tracking</td>
                                <td>-</td>
                                <td><a href=""><i class="fa fa-angle-double-right font26"></i></a></td>
                            ...
                            <tr>                                
                                <td class="font16 med-green">{!! HTML::image('img/r-2.png',null,['class'=>'margin-r-10']) !!} Future Appointments</td>
                                <td>-</td>
                                <td><a href=""><i class="fa fa-angle-double-right font26"></i></a></td>
                            </tr>
                            
                            <tr>                                
                                <td class="font16">{!! HTML::image('img/r-2.png',null,['class'=>'margin-r-10']) !!} No Show Visits</td>
                                <td>12/12/2016</td>
                                <td><a href=""><i class="fa fa-angle-double-right font26"></i></a></td>
                            </tr>
                            
                            <tr>                                
                                <td class="font16 med-green">{!! HTML::image('img/r-2.png',null,['class'=>'margin-r-10']) !!} Provider Appointments</td>
                                <td>12/12/2016</td>
                                <td><a href=""><i class="fa fa-angle-double-right font26"></i></a></td>
                            </tr>                                                        
                            
                            <tr>                                
                                <td class="font16">{!! HTML::image('img/r-2.png',null,['class'=>'margin-r-10']) !!} Recall Reports</td>
                                <td>12/12/2016</td>                                
                                <td><a href=""><i class="fa fa-angle-double-right font26"></i></a></td>
                            </tr>                            
                        </tbody>
