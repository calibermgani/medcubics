...
<div class="row toolbar-header">
    <section class="content-header">
        <h1>
            <small class="toolbar-heading"><i class="livicon med-breadcrum" data-name="barchart"></i> Reports <i class="fa fa-angle-double-right med-breadcrum" data-name="angle-wide-right"></i> <span>Aging Analysis Details Reports</span></small>
            ...
            <div class="box-body form-horizontal">
                ...
                <div class="col-lg-5 col-md-6 col-sm-12 col-xs-12 margin-t-10 js_search_part">
                    ...
                    <div class="form-group-billing">
                        {!! Form::label('Claim By', 'Claim By', ['class'=>'col-lg-4 col-md-5 col-sm-6 col-xs-12 control-label']) !!}                                                    
