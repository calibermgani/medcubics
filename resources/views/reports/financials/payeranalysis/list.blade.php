...
<div class="row toolbar-header">
    <section class="content-header">
        <h1>
            <small class="toolbar-heading"><i class="livicon med-breadcrum" data-name="barchart"></i> Reports <i class="fa fa-angle-double-right med-breadcrum" data-name="angle-wide-right"></i> Financial Reports <i class="fa fa-angle-double-right med-breadcrum" data-name="angle-wide-right"></i>  <span>Payer Analysis</span></small>
        </h1>
        <ol class="breadcrumb">
                ...
                <ul class="dropdown-menu" style="margin-top: 3px; display: none;">
                    <li>
                        <ul class="menu" style="list-style-type:none; ">
                            <li>
                                <a href="{!! url('reports/financials/payerexport/xlsx') !!}" data-url="{!! url('reports/financials/payerexport') !!}" data-option="xlsx" class="set_payer">
                                    <i class="fa fa-file-excel-o"></i> Excel
                                </a>
                            </li>
                            <li>
                                <a href="{!! url('reports/financials/payerexport/pdf') !!}" data-url="{!! url('reports/financials/payerexport') !!}" !!}" data-option="pdf" class="set_payer">
                                    <i class="fa fa-file-pdf-o" data-placement="right" data-toggle="tooltip" data-original-title="pdf"></i> PDF
                                </a>
                            </li>
                            <li>
                                <a href="{!! url('reports/financials/payerexport/csv') !!}" data-url="{!! url('reports/financials/payerexport') !!}" data-option="csv" class="set_payer">
    ...
    <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
        <div class="box box-view no-shadow ">
            ...
            <div class="box-body yes-border" style="border-color:#85E2E6;border-radius: 0px 0px 4px 4px;">
                {!! Form::open(['onsubmit'=>"event.preventDefault();",'id'=>'js-bootstrap-searchvalidator_edt', 'name'=>'medcubicsform', 'url'=>'reports/financials/payerfilter', 'data-url'=>'reports/financials/payerfilter']) !!}

                <h3 class="san-heading p-l-2 margin-t-m-10 margin-b-25" style="font-size:28px !important;">Payer Analysis</h3>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-horizontal no-padding js_search_part">
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            ...
                            <div class="form-group">
                                {!! Form::label('Payer', 'Payer', ['class'=>'col-lg-4 col-md-5 col-sm-3 col-xs-3 control-label']) !!}
                                <div class="col-lg-7 col-md-6 col-sm-6 col-xs-9">
                                    {!! Form::select('payer', ['all'=>'All','patient' => 'Patient','insurance' => 'Insurance'],null,['class'=>'select2 form-control js_select_basis_change','tabindex'=>'4']) !!}
                                </div>                        
                            </div>

                            <div class="form-group">
                                {!! Form::label('Transaction Date', 'Transaction Date', ['class'=>'col-lg-4 col-md-5 col-sm-3 col-xs-3 control-label']) !!}
                                <div class="col-lg-7 col-md-6 col-sm-6 col-xs-9">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            ...
                            <div class="col-lg-11 col-md-11 col-sm-9 col-xs-12 no-padding">
