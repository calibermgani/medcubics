            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 no-padding ">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-bottom: 15px;"><!-- Inner width Starts -->
                    <div class="col-lg-7 col-md-7 col-sm-7 col-xs-12 ">
                        <h4 class="med-green margin-b-1 med-orange">Billing Reports</h4>
                    </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 reports-table-tr js_search_part report-menu" style="padding-bottom: 2px; padding-top: 0px;"><!-- Inner width Starts -->
                        <table class="table">
                            <tbody>
                                <tr data-url="{{ url('reports/financials/charges') }}" class="js-table-click form-cursor">
                                    <td> <h4 class="font16 med-green"><i class="fa fa-angle-double-right med-orange font20"></i> Charge Analysis - Detailed </h4></td>
                                    <td class="med-green font600 text-right"><i class="fa fa-external-link pull-right"></i></td>
                                </tr>
								
                                <tr data-url="{{ url('reports/financials/charges-payments') }}" class="js-table-click form-cursor <?php if(Auth::user()->isProvider()) echo 'hide'; ?> ">
                                    <td> <h4 class="font16 med-green"><i class="fa fa-angle-double-right med-orange font20"></i> Charges & Payments Summary </h4></td>
                                    <td class="med-green font600 text-right"><i class="fa fa-external-link pull-right"></i></td>
                                </tr>
                                <tr data-url="{{ url('reports/financials/unbilledreports') }}" class="js-table-click form-cursor">
                                    <td> <h4 class="font16 med-green"><i class="fa fa-angle-double-right med-orange font20"></i> Unbilled Claims Analysis </h4></td>
                                    <td class="med-green font600 text-right"><i class="fa fa-external-link pull-right"></i></td>
                                </tr>
                                <tr data-url="{{ url('reports/financials/enddaytotal') }}" class="js-table-click form-cursor">
                                    <td> <h4 class="font16 med-green"><i class="fa fa-angle-double-right med-orange font20"></i> End of the Day Totals </h4></td>
                                    <td class="med-green font600 text-right"><i class="fa fa-external-link pull-right"></i></td>
                                </tr>
                                <tr data-url="{{ url('reports/financials/yearend') }}" class="js-table-click form-cursor">
                                    <td> <h4 class="font16 med-green"><i class="fa fa-angle-double-right med-orange font20"></i> Year End Financials </h4></td>
                                    <td class="med-green font600 text-right"><i class="fa fa-external-link pull-right"></i></td>
                                </tr>
                                <tr data-url="{{ url('reports/financials/workrvu') }}" class="js-table-click form-cursor">
                                    <td> <h4 class="font16 med-green"><i class="fa fa-angle-double-right med-orange font20"></i> Work RVU Report</h4></td>
                                    <td class="med-green font600 text-right"><i class="fa fa-external-link pull-right"></i></td>
                                </tr>
                                <tr data-url="{{ url('reports/financials/chargecategory') }}" class="js-table-click form-cursor">
                                    <td> <h4 class="font16 med-green"><i class="fa fa-angle-double-right med-orange font20"></i> Charge Category Report</h4></td>
                                    <td class="med-green font600 text-right"><i class="fa fa-external-link pull-right"></i></td>
                                </tr>
                                <tr data-url="{{ url('reports/financials/chargelist') }}" class="js-table-click form-cursor">
                                    <td> <h4 class="font16 med-green"><i class="fa fa-angle-double-right med-orange font20"></i> Revenue Analysis Report</h4></td>
                                    <td class="med-green font600 text-right"><i class="fa fa-external-link pull-right"></i></td>
                                </tr>
                            </tbody>
                        </table>
