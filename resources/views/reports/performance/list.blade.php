            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 no-padding ">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 reports-table-tr js_search_part report-menu" style="padding-bottom: 2px; padding-top: 0px;"><!-- Inner width Starts -->
                        <table class="table">
                            <tbody>
								<tr data-url="{{ url('reports/performance/monthend') }}" class="js-table-click form-cursor">
                                ...
                                <tr data-url="{{ url('reports/performance/provider') }}" class="js-table-click form-cursor hide">
                                    <td> <h4 class="font16 med-green"><i class="fa fa-angle-double-right med-orange font20"></i> Provider Summary by Location </h4></td>
                                    <td class="med-green font600 text-right"><i class="fa fa-external-link pull-right"></i></td>
                                </tr>
                                <tr data-url="" class="js-table-click hide"><!-- {{ url('reports/demo/outstandingardemo') }} -->
                                    <td> <h4 class="font16 med-gray"><i class="fa fa-angle-double-right med-orange font20"></i> Location Performance Summary </h4></td>
                                ...
                                <tr data-url="{{ url('reports/performance/billing') }}" class="js-table-click form-cursor <?php if(Auth::user()->isProvider()) echo 'hide'; ?>">
                                    <td> <h4 class="font16 med-green"><i class="fa fa-angle-double-right med-orange font20"></i> Weekly Billing Report </h4></td>
                                    <td class="med-green font600 text-right"><i class="fa fa-external-link pull-right"></i></td>
                                </tr>
