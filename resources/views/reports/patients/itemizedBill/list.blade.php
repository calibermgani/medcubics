    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 no-padding">
        <div class="box box-view no-shadow ">
            <div class="box-body yes-border border-green border-radius-4">
                {!! Form::open(['onsubmit'=>"event.preventDefault();",'id'=>'js-bootstrap-searchvalidator', 'name'=>'medcubicsform', 'url'=>'reports/search/itemizedBillSearch', 'data-url'=>'reports/search/itemizedBillSearch']) !!}
...
<script type="text/javascript">
    ...
    var allcolumns = [];
    var listing_page_ajax_url = api_site_url+"/reports/search/itemizedBillSearch"; 
