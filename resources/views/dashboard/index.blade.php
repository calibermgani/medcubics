...
<div class="row toolbar-header" >
    <section class="content-header">
        <h1>
            <small class="toolbar-heading"><i class="livicon med-breadcrum" data-name="dashboard"></i> Dashboard <i class="fa fa-angle-double-right med-breadcrum" data-name="angle-wide-right"></i> <span> Practice Analytics </span></small>
        </h1>
        <ol class="breadcrumb">
                        ...
                        <div class="box-body no-b-t  dashboard-table">           
                            <table class="table table-responsive table-stripped">                                
                                <tbody>
                                    ...
                                    <tr class="dash-b-t-2">
                                        <td <?php if ($stats_list['chargesHoldValue'] != 0) { ?>class="font600 med-green"<?php } ?> ><a href="{{url('/charges?search=yes&status=Hold')}}" target="_blank"> Charges on Hold</a></td>
                                    ...
                                    <tr>                                                           
                                        <td <?php if ($stats_list['ReadyToSubmitValue'] != 0) { ?>class="font600 med-green"<?php } ?>> <a href="{{url('/charges?search=yes&status=Ready')}}" target="_blank"> Ready to Submit</a></td>
                                    ...
                                    <tr>                                           
                                        <td <?php if ($stats_list['chargesEraValue'] != 0) { ?>class="font600 med-green"<?php } ?>> <a href="{{url('payments/get-e-remittance')}}" target="_blank"> Pending ERA</a></td>
                                        <td <?php if ($stats_list['chargesEraValue'] != 0) { ?>class="font600 med-red"<?php } ?>><?php echo $stats_list['chargesEraValue']; ?></td>
                                        <td><i class="fa <?php if ($stats_list['chargesEraValue'] == 0) { ?> fa-check-square-o med-green <?php } else { ?> fa-square-o med-red<?php } ?> font16 margin-r-10 dash-icon"></i></td>
                                    </tr>

                                    <tr>                                           
                                        <td <?php if ($stats_list['chargesDeniedValue'] != 0) { ?>class="font600 med-green"<?php } ?>><a href="{{url('/charges?search=yes&status=Denied')}}" target="_blank"> Denied Claims</a></td>
                                    ...
                                    <tr>                                        
                                        <td <?php if ($stats_list['chargesPendingValue'] != 0) { ?>class="font600 med-green"<?php } ?>><a href="{{url('/charges?search=yes&status=Pending')}}" target="_blank"> Pending Claims</a></td>
                                    ...
                                    <tr>										
                                        <td <?php if ($stats_list['problem_list_count'] != 0) { ?>class="font600 med-green"<?php } ?>><a href="{{url('/armanagement/problemlist')}}" target="_blank">Assigned Workbench</a></td>
									...
									<tr>										
                                        <td <?php if ($stats_list['document_count'] != 0) { ?>class="font600 med-green"<?php } ?>><a href="{{url('/documents?doctype=all')}}" target="_blank">Assigned Documents</a></td>
                                    ...
                                    <tr>										
                                        <td <?php if ($stats_list['ediRejectionCount'] != 0) { ?>class="font600 med-green"<?php } ?>><a href="{{url('/claims/status/rejected')}}" target="_blank">EDI Rejections</a></td>
...
@if((isset($stats_list['workbench_by_user']) && $stats_list['workbench_by_user']!=0) || (isset($stats_list['document_by_user']) && $stats_list['document_by_user']!=0 ) || (isset($stats_list['followup_by_user']) && $stats_list['followup_by_user']!=0 ))
...
<div class="snackbar-alert success menu">
    ...
    @endif
    @if(isset($stats_list['followup_by_user']) && $stats_list['followup_by_user']!=0 )
        <div class="font600 col-sm-6">Follow Up</div>
        <div class="font600 col-sm-6">{{isset($stats_list['followup_by_user'])?$stats_list['followup_by_user']:0 }}</div>
    @endif
</div>
@endif
...
<script>
	var curr_url = '{{url("analytics/practice")}}';
	
	$(document).on('ifToggled click', '.js-refresh-data', function () {
		$.ajax({
			type: 'POST',
			url: api_site_url + '/dashboard/refreshstats',
	...
	var revenueChart = new FusionCharts({
            ...
            type: 'pie3d',
                    ...
                    "data": [{"label":"0-30", "value":"<?= $AgingPiePercentValue0_30; ?>%"},
                            ...
                            {"label":">150", "value":"<?= $AgingPiePercentValue151_180; ?>%"}
                            ]
