...
<div class="row toolbar-header">
    <section class="content-header">
        <h1>
            <small class="toolbar-heading"><i class="fa fa-medkit font14"></i> Practice <i class="fa fa-angle-double-right med-breadcrum" data-name="angle-wide-right"></i> <span>New Billing</span></small>
        </h1>
        <ol class="breadcrumb">
...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-top: -13px; padding-top: 0px;"><!-- Inner Content for full width Starts -->
    <div class="box-body-block"><!--Background color for Inner Content Starts -->
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 yes-border no-padding"><!-- General Details Full width Starts -->
            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 right-border no-padding"><!-- Only general details content starts -->
                <div class="box no-border  no-shadow"><!-- Box Starts -->
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><!--  1st Content Starts -->
                        ...
                        <div class="box-body form-horizontal"><!-- Box Body Starts -->
                            <div class="form-group-billing">
                                {!! Form::label('Rendering Provider', 'Rendering Provider', ['class'=>'col-lg-5 col-md-5 col-sm-4 control-label-billing med-green']) !!} 
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-10 billing-select2 @if($errors->first('rendering_provider_id')) error @endif">
                                    {!! Form::select('rendering_provider_id', array('' => '-- Select --') + (array)$rendering_providers,  $rendering_provider_id,['class'=>'select2 form-control']) !!}  
                            ...
                            <div class="form-group-billing">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-10 billing-select2 @if($errors->first('referring_provider_id')) error @endif">
                                    {!! Form::select('referring_provider_id', array('' => '-- Select --') + (array)$referring_providers,  $referring_provider_id,['class'=>'select2 form-control']) !!}  
                            ...
                            <div class="form-group-billing">
                                {!! Form::label('Billing Provider', 'Billing Provider', ['class'=>'col-lg-5 col-md-5 col-sm-4 control-label-billing med-green']) !!} 
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-10 billing-select2 @if($errors->first('billing_provider_id')) error @endif">
                                    {!! Form::select('billing_provider_id', array('' => '-- Select --') + (array)$billing_providers,  $billing_provider_id,['class'=>'select2 form-control']) !!}  
                            ...
                            <div class="form-group-billing">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-10 billing-select2 @if($errors->first('facility_id')) error @endif">  
                            ...
                            <div class="form-group-billing">
                                {!! Form::label('authorization', 'Authorization', ['class'=>'col-lg-5 col-md-5 col-sm-4 col-xs-12 control-label-billing med-green']) !!}                                                  
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-10 billing-select2">  
                                    {!! Form::text('authorization',null,['maxlength'=>'25','class'=>'form-control input-sm-modal-billing','readonly'=>'readonly']) !!}
                                </div>   
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" style="background: #fffbeb;  border-left: 1px solid #f0f0f0;"><!--  2nd Content Starts -->
                        ...
                        <div class="box-body form-horizontal js-address-class" id="js-address-primary-address">
                            ...
                            <div class="form-group-billing">
                                {!! Form::label('pos', 'POS',  ['class'=>'col-lg-4 col-md-4 col-sm-4 col-xs-12 control-label-billing med-green']) !!} 
                                <div class="col-lg-7 col-md-7 col-sm-7 col-xs-10 billing-select2">
                                    {!! Form::select('insurance_id', array(''=>'-- Select --')+(array)$insurances,  $insurance_id,['class'=>'select2 form-control']) !!}
                                </div>                                                       
                            </div>
                            ...
                            <div class="form-group-billing">
                                {!! Form::label('Copay', 'Co-Pay',  ['class'=>'col-lg-4 col-md-4 col-sm-4 col-xs-12 control-label-billing med-green']) !!} 
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-10 billing-select2">
                                    {!! Form::select('employer_id',array(''=>'--','Cash'=>'Cash','Check'=>'Check','Credit Card'=>'Credit Card','Others'=>'Others'),null,['class'=>'form-control select2 input-sm-modal-billing']) !!}
                                </div>
                            ...
                            <div class="form-group-billing">
                                {!! Form::label('mode', 'Details',  ['class'=>'col-lg-4 col-md-4 col-sm-4 col-xs-12 control-label-billing med-green']) !!} 
                                <div class="col-lg-7 col-md-7 col-sm-7 col-xs-10 billing-select2">
            ...
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12" style="background: #eeffff; "><!-- ICD Details Starts here -->
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 med-orange no-padding" style="margin-top: -10px;">
                    <span class="bg-white">ICD 10</span>
                </div>
                <div class="box-body form-horizontal">

                    <div class="form-group-billing">                            
                        {!! Form::label('DOI', '1',  ['class'=>'col-lg-1 col-md-1 col-sm-1 col-xs-12 control-label']) !!} 
                        ...
                        {!! Form::label('Billed Date', '7',  ['class'=>'col-lg-1 col-md-1 col-sm-1 col-xs-12 control-label']) !!} 
                        <div class="col-lg-4 col-md-4 col-sm-3 col-xs-10">
                            {!! Form::text('billed_date',null,['class'=>'form-control input-sm-modal-billing']) !!}                    
                        </div>
                        <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">
                            <i class="fa fa-info med-green form-icon-billing"></i>
                        </div>
                    ...
                    <div class="form-group-billing">                            
                        {!! Form::label('DOI', '2',  ['class'=>'col-lg-1 col-md-1 col-sm-1 col-xs-12 control-label']) !!} 
                        <div class="col-lg-4 col-md-4 col-sm-3 col-xs-10">
                            {!! Form::text('doi',null,['class'=>'form-control input-sm-modal-billing']) !!}
                        </div>
                        <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">
                        ...
                        {!! Form::label('Billed Date', '8',  ['class'=>'col-lg-1 col-md-1 col-sm-1 col-xs-12 control-label']) !!} 
                        <div class="col-lg-4 col-md-4 col-sm-3 col-xs-10">
                            {!! Form::text('billed_date',null,['class'=>'form-control input-sm-modal-billing']) !!}                    
                        </div>     
                        <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">
                    ...
                    <div class="form-group-billing">                            
                        {!! Form::label('DOI', '3',  ['class'=>'col-lg-1 col-md-1 col-sm-1 col-xs-12 control-label']) !!} 
                        <div class="col-lg-4 col-md-4 col-sm-3 col-xs-10">
                            {!! Form::text('doi',null,['class'=>'form-control input-sm-modal-billing']) !!}
                        </div>
                        <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">
                        ...
                        {!! Form::label('Billed Date', '9',  ['class'=>'col-lg-1 col-md-1 col-sm-1 col-xs-12 control-label']) !!} 
                        <div class="col-lg-4 col-md-4 col-sm-3 col-xs-10">
                            {!! Form::text('billed_date',null,['class'=>'form-control input-sm-modal-billing']) !!}                    
                        </div>          
                        <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">
                    ...
                    <div class="form-group-billing">                            
                        {!! Form::label('DOI', '4',  ['class'=>'col-lg-1 col-md-1 col-sm-1 col-xs-12 control-label']) !!} 
                        <div class="col-lg-4 col-md-4 col-sm-3 col-xs-10">
                            {!! Form::text('doi',null,['class'=>'form-control input-sm-modal-billing']) !!}
                        </div>
                        <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">
                        ...
                        {!! Form::label('Billed Date', '10',  ['class'=>'col-lg-1 col-md-1 col-sm-1 col-xs-12 control-label']) !!} 
                        <div class="col-lg-4 col-md-4 col-sm-3 col-xs-10">
                            {!! Form::text('billed_date',null,['class'=>'form-control input-sm-modal-billing']) !!}                    
                        </div>      
                        <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">
                    ...
                    <div class="form-group-billing">                            
                        {!! Form::label('DOI', '5',  ['class'=>'col-lg-1 col-md-1 col-sm-1 col-xs-12 control-label']) !!} 
                        <div class="col-lg-4 col-md-4 col-sm-3 col-xs-10">
                            {!! Form::text('doi',null,['class'=>'form-control input-sm-modal-billing']) !!}
                        </div>
                        <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">
                        ...
                        {!! Form::label('Billed Date', '11',  ['class'=>'col-lg-1 col-md-1 col-sm-1 col-xs-12 control-label']) !!} 
                        <div class="col-lg-4 col-md-4 col-sm-3 col-xs-10">
                            {!! Form::text('billed_date',null,['class'=>'form-control input-sm-modal-billing']) !!}                    
                        </div>                   
                        <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">
                    ...
                    <div class="form-group-billing margin-b-5">                            
                        {!! Form::label('DOI', '6',  ['class'=>'col-lg-1 col-md-1 col-sm-1 col-xs-12 control-label']) !!} 
                        <div class="col-lg-4 col-md-4 col-sm-3 col-xs-10">
                            {!! Form::text('doi',null,['class'=>'form-control input-sm-modal-billing']) !!}
                        </div>
                        <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">
                        ...
                        {!! Form::label('Billed Date', '12',  ['class'=>'col-lg-1 col-md-1 col-sm-1 col-xs-12 control-label']) !!} 
                        <div class="col-lg-4 col-md-4 col-sm-3 col-xs-10">
                            {!! Form::text('billed_date',null,['class'=>'form-control input-sm-modal-billing']) !!}                    
                        </div>     
                        <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">
                    ...
                    <table class="table-billing-view superbill-claim">
                        <tbody>
                            <tr>
                                ...
                                <td style="text-align: center; width: 4%">{!! Form::select('preferred_communication', ['sd'=>'--','12122' => '0A','67876' => '2E','J5645' => '0H','67758'=>'2L'],null,['class'=>'select2 input-sm form-control']) !!}</td>
                                <td style="text-align: center; width: 4%">{!! Form::select('preferred_communication', ['sd'=>'--','12122' => '0A','67876' => '2E','J5645' => '0H','67758'=>'2L'],null,['class'=>'select2 input-sm form-control']) !!}</td>
                                <td style="text-align: center; width: 18%">{!! Form::text('pointers',null,['style'=>'border: 0px solid #e8e8e8; width: 100%; border-radius: 4px; text-align: center;']) !!}</td>
                                <td style="text-align: center; width: 5%"><input type="text" class="" style="border: 0px solid #e8e8e8; width: 100%; border-radius: 4px; text-align: center;"></td>
                                <td style="text-align: center; width: 6%"><input type="text" class="" style="border: 0px solid #e8e8e8; width: 100%; border-radius: 4px; text-align: center;"></td>                              
                            </tr>
                        </tbody>
                    ...
                    <table class="table-billing-view superbill-claim">
                        <tbody>
                            <tr>
                                ...
                                <td style="text-align: center; width: 13%;"><span class="med-orange">Total Charges</span></td>  
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 space10 no-padding">
            <a href="#additional" data-toggle="modal" data-target="#additional" class="add-btn">Claim Details</a>             
            <a href="#ambulance" data-toggle="modal" data-target="#ambulance" class="add-btn">Ambulance Billing</a>
            <a href="#others" data-toggle="modal" data-target="#others" class="add-btn">Other Details</a>

            <div class="pull-right no-padding">
                <a href="#others" data-toggle="modal" data-target="#others" ><input type="submit" value="HCFA Preview" class="add-btn no-border"></a>
                <a href="#others" data-toggle="modal" data-target="#others" ><input type="submit" value="Problem List" class="add-btn no-border"></a> 
            </div>
        </div>
...
<div id="hold_reason" class="modal fade in">
    <div class="modal-md">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title"> Hold Reason</h4>
            </div>
                ...
                <div class="box box-view no-shadow no-border"><!--  Box Starts -->
                    ...
                    <div class="box-body form-horizontal no-padding">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="border-top:1px solid #f0f0f0; padding: 10px;">
                            ...
                            <div class="form-group-billing">                             
                                {!! Form::label('employer_id', 'Reason', ['class'=>'col-lg-3 col-md-3 col-sm-6 col-xs-12 control-label-billing']) !!}                           
                                <div class="col-lg-7 col-md-7 col-sm-6 col-xs-10">
                                    {!! Form::select('employer_id',array(''=>'-- Select --','Employer'=>'Reason 1','Employer 1'=>'Reason 2','Employer 1'=>'Reason 3'),null,['class'=>'form-control input-sm-modal-billing']) !!}
                                </div>                        
                                <div class="col-sm-1">
                            ...
                            <div class="form-group-billing">                             
                                {!! Form::label('attorney_id', 'Notes', ['class'=>'col-lg-3 col-md-3 col-sm-6 col-xs-12 control-label-billing']) !!}                           
                                <div class="col-lg-7 col-md-7 col-sm-6 col-xs-10">
                                    {!! Form::textarea('box_8',null,['class'=>'form-control input-sm-modal-billing']) !!}
                                </div>                        
                                <div class="col-sm-1">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12  space10">   
                            ...
                            <div class="form-group-billing">                                                                        
                                <div class="col-lg-11 col-md-11 col-sm-11 col-xs-11">
                                    {!! Form::textarea('stretcher_purpose',null,['class'=>'form-control input-sm-modal-billing','placeholder'=>'Medical Office Notes','style'=>'height:140px;']) !!} 
                                </div>                                 
                                <div class="col-sm-1"></div>
                            </div>
                        </div>
