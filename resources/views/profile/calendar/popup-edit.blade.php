			...
			<div class="no-shadow">
				<div class="box-body form-horizontal">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 tab-border-bottom">   
						...
						<input type="hidden" value ="{{@$reminder->event_id}}" name="event_id" />
						<div class="form-group">
							{!! Form::label('Date', 'Date', ['class'=>'col-lg-3 col-md-3 col-sm-4 col-xs-12 control-label-popup']) !!}
							<div class="col-lg-4 col-md-4 col-sm-5 col-xs-5">
								{!! Form::text('start_date',@$reminder->start_date,['class'=>'form-control input-sm-header-billing form-cursor js_date_picker','id'=>"start_date","style"=>"font-size:13px;"]) !!}
							</div>	
							<div class="col-lg-1 col-md-1 col-sm-1 col-xs-1"><i class="fa fa-arrows-h med-green"></i></div>
							<div class="col-lg-4 col-md-4 col-sm-5 col-xs-5">
								{!! Form::text('end_date',@$reminder->end_date,['class'=>'form-control input-sm-header-billing form-cursor end_date js_date_picker' ,'id'=>"end_date","style"=>"font-size:13px;"]) !!}
							</div>	
							<input type="hidden" value ="{{@$reminder->end_date}}" id="end_date_hide" />
						</div>
						<div class="form-group">
							{!! Form::label('Time', 'Time', ['class'=>'col-lg-3 col-md-3 col-sm-4 col-xs-6 control-label-popup']) !!} 
							<div class="col-lg-4 col-md-4 col-sm-5 col-xs-5">
								{!! Form::text('start_time',$start_time,['class'=>'form-control input-sm-header-billing form-cursor','id'=>"start_time"]) !!}
							</div>	
							<div class="col-lg-1 col-md-1 col-sm-1 col-xs-1"><i class="fa fa-arrows-h med-green"></i></div>
							<div class="col-lg-4 col-md-4 col-sm-5 col-xs-5">
								{!! Form::text('end_time',$end_time,['class'=>'form-control input-sm-header-billing form-cursor end_time','id'=>"end_time", 'placeholder'=>"00:00"]) !!}
							</div>	
						</div>
						<div class="form-group">
						...
						<div class="reminder_type @if(@$reminder->reminder_type !='repeat') hide @endif" id="js_reminder_type_repeat">
							<div class="form-group">
								...
								<div class="col-lg-9 col-md-9 col-sm-10 col-xs-12 control-label">
							...
							<div class="reminder_type_repeat" id="js_reminder_type_repeat_on">
								<div class="form-group">
									{!! Form::label('Repeated By', 'Repeated By', ['class'=>'col-lg-3 col-md-3 col-sm-10 col-xs-12 control-label-popup med-green']) !!} 
								...
								<div class="form-group repeated_by @if(@$reminder->repeated_by =='Monthly')show @else hide @endif" id="js_reminder_type_repeated_by_Monthly">
									{!! Form::label('Reminder Date', 'Reminder Date', ['class'=>'col-lg-4 col-md-4 col-sm-10 col-xs-12 control-label-popup med-green']) !!} 
									<div class="col-lg-4 col-md-4 col-sm-10 col-xs-10">
										...
										'class'=>'form-control input-sm-header-billing form-cursor js_date_picker']) !!}
									</div>
								...
								<div class="form-group repeated_by @if(@$reminder->repeated_by =='Yearly')show @else hide @endif" id="js_reminder_type_repeated_by_Yearly">
									{!! Form::label('Reminder Date', 'Reminder Date', ['class'=>'col-lg-4 col-md-4 col-sm-10 col-xs-12 control-label-popup']) !!} 
									<div class="col-lg-4 col-md-4 col-sm-10 col-xs-10">
										<i class="fa fa-calendar-o form-icon-billing"></i> 
