                ...
                <div class="box-body form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-6 col-md-7 col-sm-6 col-xs-10 ">
                          <i class="fa fa-calendar-o form-icon"></i>   {!! Form::text('provider_dob',null,['id'=>'date_of_birth','readonly','class'=>'form-control form-cursor']) !!}  
                        </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <center>
                    {!! HTML::image('media/sign/'.$provider->digital_sign_name.'.'.$provider->digital_sign_ext) !!}</center>
            </div>
