		...
		<div id="compose_mail" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 no-padding hide"> 
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="background:#e7fcfd;margin-top:-10px;padding:10px 0px;">
				<div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">
					<a class="col-lg-11 col-md-11 col-sm-11 col-xs-11 med-btn" data-page-type="replay" data-message-type="send" id="send_compose_message" data-previous-id="{!! $message_data[0]->message_id !!}" style="padding:16px 10px;">
				...
				<div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">
					<a class="col-lg-9 col-md-9 col-sm-9 col-xs-9 med-btn" id="send_compose_message" data-message-type="draft" data-message-id="{!! $message_data[0]->message_id !!}" data-page-type="replay" style="padding:10px 5px;">
