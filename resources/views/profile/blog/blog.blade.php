...
<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 margin-t-m-13"><!-- Left side Outer body starts -->
    ...
    <div class="col-lg-12 col-md-12 col-xs-12 col-xs-12 no-padding"  ><!-- Blog Header Starts -->
        ...
        <ul class="nav nav-tabs">                      	          
            <li class=" "><a href="{{ url('profile/blogs') }}"><i class="fa fa-comments i-font-tabs"></i> Blogs</a></li>
            <li class="active"><a href="" style="background:#fff !important;"><i class="fa fa-comments i-font-tabs"></i> Manage Blogs</a></li>  
			<li class=""><a href="{{ url('profile/bloggroup')}}"><i class="fa fa-comments i-font-tabs"></i> Manage Group</a></li> 
            @if($checkpermission->check_url_permission('profile/blog/create') == 1)
            <li class="pull-right">                
                <a href="{{ url('profile/blog/create') }}" ><i class="fa {{Config::get('cssconfigs.common.plus_circle')}}"></i> New Blog</a>             
            </li>
            @endif
        </ul>
    </div>
        <div class="box box-view no-shadow no-border no-border-radius">
            <div class="box-body padding-t-20">
                ...
                <div class="col-lg-5 col-md-6 col-sm-4 xol-xs-5 no-padding">                
                    <span class="input-group input-group-sm">
                        ...
                        <span class="input-group-btn">
                            <button type="button" class="btn btn-flat btn-medgreen js_search_blog_button">Search</button>
                        </span>
                    </span>
                ...
                <div class="col-lg-7 col-md-6 col-sm-8 col-xs-12 no-padding"> 
					...
					<select id="js-blog-sort" class="dev-sort" style="color:black;float:right;padding:4px">
...
<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 p-l-0">
	...
	@include('profile/blog/favourites')
