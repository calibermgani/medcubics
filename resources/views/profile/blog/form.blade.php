...
<h3 class="box-title"><i class="livicon" data-name="info" data-color='#008e97' data-size='16'></i> New Blog</h3>
...
href="{{ url('profile/blog/delete/'.$blog->id) }}">Delete</a>
  <a href="javascript:void(0)" data-url="{{url('profile/blog/'.$blog->id)}}"> {!! Form::button('Cancel', ['class'=>'btn btn-medcubics js_cancel_site']) !!}</a>
@else
<a href="javascript:void(0)" data-url="{{url('profile/blog')}}"> {!! Form::button('Cancel', ['class'=>'btn btn-medcubics js_cancel_site']) !!}</a>
  @endif
</div>
