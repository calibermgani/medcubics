...
<div class="row toolbar-header">
    <section class="content-header">
        <h1>
            <small class="toolbar-heading"><i class="fa {{Config::get('cssconfigs.Practicesmaster.user')}} med-breadcrum med-green"></i> Profile <i class="fa fa-angle-double-right med-breadcrum" data-name="angle-wide-right"></i>  <span>Blogs</span></small>
        </h1>
        <ol class="breadcrumb">
...
<div class="col-lg-9 col-md-8 col-sm-12 col-xs-12 margin-t-m-13"><!-- Left side Outer body starts -->
    ...
    <div class="col-lg-12 col-md-12 col-xs-12 col-xs-12 no-padding"  ><!-- Blog Header Starts -->
        <div class="med-tab nav-tabs-custom no-bottom">
            <ul class="nav nav-tabs">                      	          
                <li class=" active"><a href="" style="background:#fff !important;"><i class="fa fa-comments i-font-tabs"></i> Blogs</a></li>
                <li class=""><a href="{{ url('profile/blog') }}" ><i class="fa fa-comments i-font-tabs"></i> Manage Blogs</a></li>  
