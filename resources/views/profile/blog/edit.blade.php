...
@section('practice')
   <!--1st Data-->
	{!! Form::model($blog, ['method'=>'PATCH','id'=>'js-bootstrap-validator','class'=>'blog_create_form medcubicsform','enctype'=>'multipart/form-data','url'=>'/profile/blog/'.$blog->id,'name'=>'medcubicsform']) !!}   
