    ...
    <body> 
		...
		<div id="compose_mail" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 no-padding hide"> 
			{!! Form::open(['name'=>'mailcomposerform','id'=>'mailcomposerform','files'=>true]) !!}
				{!! Form::hidden('mail_sent_type',@$chk_draft,['id'=>'mail_sent_type','class'=>'mail_sent_type']) !!}
				{!! Form::hidden('curr_mail_id',@$mail_id,['id'=>'curr_mail_id','class'=>'curr_mail_id']) !!}
			<div>
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="background:#e7fcfd;margin-top:-10px;padding:10px 0px;">
				<div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">
					<a class="col-lg-11 col-md-11 col-sm-11 col-xs-11 med-btn" id="send_compose_mail" style="padding:16px 10px;">
				...
				<div class="col-lg-10 col-md-10 col-sm-10 col-xs-10 form-horizontal">
					<div class="form-group">
						...
						{!! Form::select('to_address', (array)@$users_list,$to_address, ['multiple'=>'multiple','name'=>'to_address', 'class' => 'form-control tokenfield select2 ']) !!}
						</span>
					</div>
					<div class="form-group">
						<span class="pull-left" style="color:#00877f;">Subject&emsp; </span>
						<span class="col-lg-11 col-md-11 col-sm-11 col-xs-11">
							{!! Form::text('mail_subject',@$mail_subject,['id'=>'mail_subject','class'=>'form-control  input-sm','placeholder'=>'Subject:']) !!} 
						</span>
					</div>
					<div style="margin-left: -15px;">                
						...
						@if(@$attachment_file!='')                    
							<span><a href="{{ url('/media/private_message/'.@$attachment_file) }}" target="_blank" class="">Previous Attachment <i class="fa fa-paperclip"></i></a></span>
						@endif
					</div>
				</div>
				<div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">
					<a class="col-lg-9 col-md-9 col-sm-9 col-xs-9 med-btn" id="add_draft_compose_mail" style="padding:10px 5px;">
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 no-padding">
				<div class="box-body no-padding">
					<div class="form-group">
						<textarea name="compose-textarea" id="compose-textarea" height="700px"><br>@if(@$chk_draft == "reply"){!! @$mail_settings_datas->signature_content !!} @endif<span style="font-size:12px">{{ $exists_content }}</textarea>
					</div>
				</div>
			</div><!-- /. box -->
			{!! Form::close() !!}
