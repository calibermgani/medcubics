...
<div class="row toolbar-header">
    <section class="content-header">
        <h1>
            <small class="toolbar-heading"><i class="fa {{Config::get('cssconfigs.admin.role')}} font14"></i> Roles <i class="fa fa-angle-double-right med-breadcrum" data-name="angle-wide-right"></i><span> Practice </span></small>
        </h1>
        <ol class="breadcrumb">
        <li><a href="{{ url('admin/practicerole') }}"><i class="fa fa-reply" data-placement="bottom"  data-toggle="tooltip" data-original-title="Back"></i></a></li>
            ...
            <li><a href="javascript:void(0);" class="js-print"><i class="fa fa-print" data-placement="bottom"  data-toggle="tooltip" data-original-title="Print"></i></a></li>
             @if($checkpermission->check_adminurl_permission('api/admin/practicerole/{export}') == 1)
             <li class="dropdown messages-menu"><a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-share-square-o" data-placement="bottom"  data-toggle="tooltip" data-original-title="Export"></i></a>
                @include('layouts.practice_module_export', ['url' => 'api/admin/practicerole/'])
            </li>
             @endif
        ...
        <div class="box-header margin-b-10">
           <i class="livicon" data-name="responsive-menu"></i> <h3 class="box-title">Role List</h3>
            <div class="box-tools pull-right margin-t-2">
                ...
                <a href="{{ url('admin/role/create') }}" class="font600 font14"><i class="fa fa-plus-circle"></i> New Roles</a>
            @endif
            </div>
        </div><!-- /.box-header -->
        <div class="box-body">
           <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr data-url="{{ url('admin/role/'.$role->id) }}" class="js-table-click clsCursor">
                            ...
                            <td>
                                @if($checkpermission->check_adminurl_permission('admin/setpagepermissions/{setpagepermissions}/edit') == 1)
                                <a href="{{ url('admin/setpagepermissions/'.$role->id.'/edit') }}"><span class="font600 med-orange">Set Permission</span></a>
                                @endif
                            </td>
                        </tr>
                        @endforeach
