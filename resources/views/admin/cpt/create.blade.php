...
<div class="row toolbar-header">
    <section class="content-header">
        <h1>
            <small class="toolbar-heading"><i class="fa {{Config::get('cssconfigs.Practicesmaster.contact_detail')}} font14"></i> CPT <i class="fa fa-angle-double-right med-breadcrum" data-name="angle-wide-right"></i> <span>New CPT</span></small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="javascript:void(0)" data-url="{{ url('admin/cpt') }}" class="js_next_process"><i class="fa fa-reply" data-placement="bottom"  data-toggle="tooltip" data-original-title="Back"></i></a></li>
...
@section('practice-info')
	{!! Form::open(['url'=>['admin/cpt'],'id'=>'js-bootstrap-validator','files'=>true,'name'=>'medcubicsform','class'=>'medcubicsform']) !!}
				...
				<div class="col-lg-6 col-md-6 col-sm-9 col-xs-12 form-horizontal">
					<div class="form-group">
						<div class="col-lg-11 col-md-11 col-sm-11 col-xs-11 @if($errors->first('cpt_hcpcs')) error @endif">
							{!! Form::text('cpt_hcpcs', null,['placeholder' => 'CPT / HCPCS','class'=>'form-control','maxlength'=>6]) !!}
				...
				<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 form-horizontal med-left-border">
					...
					<div class="form-group">
						...
						<div class="col-lg-6 col-md-7 col-sm-8 col-xs-10 @if($errors->first('effectivedate')) error @endif">
							...
							{!! Form::text('effectivedate', null,['placeholder'=>Config::get('siteconfigs.default_date_format'),'id'=>'effectivedate','class'=>'dm-date form-control input-sm-header-billing']) !!}
