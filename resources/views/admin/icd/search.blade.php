...
@section('toolbar')
	<div class="row toolbar-header">
		<section class="content-header">
			<h1>
				<small class="toolbar-heading"><i class="fa {{Config::get('cssconfigs.common.icd')}}" data-name="archive-extract"></i>ICD-10</small>
			</h1>
			<ol class="breadcrumb">
		...
		<div class="box-body-block"><!--Background color for Inner Content Starts -->
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
				...
				<div id="overlay_part" class="overlay col-xs-offset-2 hide">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 med-green font600 text-center js_processing_image hide"> <i class="fa fa-spinner fa-spin font20"></i> Processing </div>
				</div>
