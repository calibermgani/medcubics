...
<h1>
<small class="toolbar-heading">ICD 09 - <span>Import</span></small>
</h1>
<ol class="breadcrumb">
...
@section('practice')
{!! Form::open(['url'=>'medcubics-admin/importicd09','id'=>'js-bootstrap-validator','files'=>true]) !!}
@include ('admin/icd/import-09/form',['submitBtn'=>'Save'])
{!! Form::close() !!}
@stop
