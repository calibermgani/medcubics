...
<h1>
<small class="toolbar-heading">ICD 10 - <span>Import</span></small>
</h1>
<ol class="breadcrumb">
...
@section('practice')
{!! Form::open(['url'=>'medcubics-admin/importicd10','id'=>'js-bootstrap-validator','files'=>true]) !!}
@include ('admin/icd/import-10/form',['submitBtn'=>'Save'])
{!! Form::close() !!}
@stop
