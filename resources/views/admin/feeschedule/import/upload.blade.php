...
<div class="row toolbar-header">
	<section class="content-header">
		<h1>
			<small class="toolbar-heading">Feeschedules - <span>Import</span></small>
		</h1>
		<ol class="breadcrumb">
...
@stop
@section('practice')
	{!! Form::open(['url'=>'medcubics-admin/importfeeschedules','id'=>'js-bootstrap-validator','files'=>true]) !!}
	@include ('admin/feeschedule/import/form',['submitBtn'=>'Save'])
	{!! Form::close() !!}
@stop
