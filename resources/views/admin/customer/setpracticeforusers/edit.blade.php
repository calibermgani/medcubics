...
<div class="row toolbar-header">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
			<li><a href="{{ url('admin/customer/'.$customer_id.'/customerusers/'.$user_id.'/setpracticeforusers') }}"><i class="fa fa-reply" data-placement="bottom"  data-toggle="tooltip" data-original-title="Back"></i></a></li>
