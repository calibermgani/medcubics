        ...
        <div class=" js-address-class" id="js-address-general-address">
            ...
            <div id="permissions_forusers">
                ...
                @php  $decode_id = $menu->id; 
                 $submenu_class =  str_replace(" ","_",$menu->menu);@endphp
				...
				@endphp
                        ...
                        $title_id = App\Http\Helpers\Helpers::getEncodeAndDecodeOfId($title_list->id,'encode');
                              $title_name = $menu->menu . '_' . $submenu->submenu . '_' . $title_list->title.'|'.$title_id;@endphp
...
<div class="js_api_settings">
    ...
    @php  $selectedpracticeapis = explode(",",$practice->api_ids)  @endphp
    <div class="box box-info no-shadow">
        <div class="box-block-header with-border">
            ...
            <div class=" js-address-class" id="js-address-general-address">
                <div class="form-group">
                    ...
                    <div class="col-lg-10 col-md-12 col-sm-12 col-xs-12 @if($errors->first('role_id')) error @endif">
                        ...
                        @php  $selecteduserapis 	 = explode(",",$Setapiforusers->api); @endphp
...
<div class="box-footer">
    <div class="col-lg-12 col-md-12  col-sm-12 col-xs-12"> 
        <div id="contact-info-footer" class="modal-footer text-center">
        <input class="btn btn-medcubics form-group" accesskey="s"  type="submit" value="Save">
