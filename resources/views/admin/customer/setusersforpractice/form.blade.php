                    ...
                    <div class=" js-address-class" id="js-address-general-address">
                        ...
                        <div id="permissions_forusers">
                            ...
                            <div data-id="js_select_all" class="ad-user-list js-check-each js_practice_module_{{$menu_class}}">
                                <div class="ad-user-menu-bg">{!! Form::checkbox('permission_menu', $menu->id,  false, ["class" => "js_select_all js_menu js_submenu flat-red",'id'=>"js_".$menu->menu."_".$decode_id,'data-class' => "js_practice_module_".$menu_class]) !!} {{ $menu->menu }}</div>
