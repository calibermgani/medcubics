...
<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 space20" >
    <div class="box no-shadow">
        ...
        <!-- form start -->
        <?php
        if(isset($adminusers->id) && $adminusers->id != ''){
            $adminusers->id = $adminusers->encid;
        }else{
        ...
        <div class="box-body  form-horizontal margin-l-10">
            <div class="form-group" style="display: none;">
                ...
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
					...
					*/ ?>
                    <input type="radio" class="js_user_pra_type" id="customer_practice_user"  name="practice_user_type" value="practice_user" checked/> {!! Form::label('customer_practice_user', 'Practice User',['class'=>'med-darkgray font600 form-cursor']) !!}
                </div>
            </div>
            <input type="hidden" name="practice_id" value="<?php echo @$prac_id; ?>" />
            <input type ='hidden' class ='js_user_type' value=<?php echo @$adminusers->practice_user_type; ?>  >
            <input type ='hidden' class ='js_user_type' name="user_id" value=<?php echo @$adminusers->id; ?>  >
            <div class="form-group js_customer">
                ...
                <div class="col-lg-6 col-md-7 col-sm-6 col-xs-10 ">
                    {!! Form::select('customer_id',array('' => '-- Select --')+(array)@$customers, $cust_id, ['class' => 'form-control select2 customer_practice_name','id'=>'js-customer', 'readonly' => 'readonly']) !!}
                </div>
            ...
            <div class="form-group js_customer_practice" >
                ...
                <div class="col-lg-6 col-md-7 col-sm-6 col-xs-10 ">
                    {!! Form::select('admin_practice_id',$customer_practices, $prac_id, ['multiple'=>'multiple','name'=>'admin_practice_id[]', 'class' => 'form-control select2 js_admin_practice_id','id'=>'customer_practice_list']) !!}
            ...
            <div class="js_prac_access_app">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-6 col-md-7  col-sm-6 col-xs-10">
                        {!! Form::select('practice_access_id', array('' => '-- Select --')+(array)$customer_practices_list, $prac_id,['class'=>'form-control select2 practice_useraccess_name','id'=>'selected_practice_list']) !!}
            ...
            @endforeach    
           <div class="form-group " >
                {!! Form::label('admin_practice_permission', 'Select Permission', ['class'=>'col-lg-4 col-md-4 col-sm-5 col-xs-12 control-label']) !!}
                <div class="col-lg-6 col-md-7 col-sm-6 col-xs-10 ">
                    {!! Form::select('admin_practice_permission',$customer_practices, $practice_ids, ['multiple'=>'multiple','name'=>'admin_practice_permission[]', 'class' => 'form-control select2 js_admin_practice_permission','id'=>'admin_practice_permission']) !!}
                    {!! $errors->first('admin_practice_id', '<p> :message</p>')  !!}
                </div>
                <div class="col-sm-1 col-xs-2"></div>
            </div>          
        ...
        <div class="box-footer">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                @if(strpos($currnet_page, 'edit') !== false)
					@if($checkpermission->check_adminurl_permission('admin/customer/{customer_id}/practice/{practice_id}/practiceusers/{id}') == 1)
						<a class="btn btn-medcubics js-delete-confirm" data-text="Are you sure would you like to delete?" href="{{ url('admin/customer/'.$customer_id.'/practice/'.$practice_id.'/practiceusers/'.$practice_user_id.'/delete') }}">Delete</a>
					@endif
						...
						validators: {
							callback: {
								...
								callback: function (value, validator, $field) {
									...
									if (value == '' && (radio == 'practice_admin' || radio == 'practice_user') && (admin_cust_val == '' || admin_cust_val == 'undefined')) {
										return {
											valid: false,
											message: '{{ trans("admin/adminuser.validation.customer") }}'
										};
					...
					short_name: {
						...
						validators: {
							...
							remote: {
								...
								data: {'short_name':$('input[name="short_name"]'),
								'user_id':$('input[name="user_id"]').val(),
								'_token':$('input[name="_token"]').val()},
								type: 'POST'
							},
