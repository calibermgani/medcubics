...
@section('toolbar')
	<div class="row toolbar-header">
		<section class="content-header">
			<h1>
				<small class="toolbar-heading"><i class="fa {{Config::get('cssconfigs.admin.users')}}" data-name="users"></i> Customers <i class="fa fa-angle-double-right med-breadcrum" data-name="angle-wide-right"></i> <span>New Customer</span></small>
			</h1>
			<ol class="breadcrumb">
				<li><a href="javascript:void(0)" data-url="{{ url('admin/customer') }}" class="js_next_process"><i class="fa fa-reply" data-placement="bottom"  data-toggle="tooltip" data-original-title="Back"></i></a></li>
...
@section('practice-info')
    {!! Form::open(['url'=>'admin/customer','id'=>'js_bootstrap_validator','files'=>true,'name'=>'medcubicsform','class'=>'medcubicsform']) !!}
            ...
            <div class="col-lg-6 col-md-6 col-sm-9 col-xs-12 form-horizontal ">
                <div class="form-group">                    
                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 @if($errors->first('customer_name')) error @endif">
                         {!! Form::text('customer_name', null,['placeholder' => 'Enter the Customer Name','class'=>'form-control js-letters-caps-format','id'=>'customer_name','maxlength'=>'50']) !!}
            ...
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 form-horizontal med-left-border">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-9 col-md-8 col-sm-8 col-xs-10 @if($errors->first('mobile')) error @endif">
                        {!! Form::text('mobile', null,['id'=>'mobile','class'=>'dm-phone form-control']) !!}
...
@section('practice')
    @include ('admin/customer/form',['submitBtn'=>'Save'])</center>
    {!! Form::close() !!}
@stop
