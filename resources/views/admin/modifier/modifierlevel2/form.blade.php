<input type="hidden" class="js_set_confirm_msg" value='{{ trans("practice/practicemaster/confirmmessage.validation.admin.modifier2") }}' />
	...
	<div class="box box-info no-shadow"><!-- Box Starts -->
		...
		<div class="box-body  form-horizontal margin-l-10"><!-- Box Body Starts -->
			<div class="form-group">                        
				{!! Form::label('modifierstype', 'Category', ['class'=>'col-lg-2 col-md-2 col-sm-3 control-label']) !!}                                                                                             
				<div class="col-lg-2 col-md-3 col-sm-6 @if($errors->first('modifiers_type_id')) error @endif">  
			...
			<div class="form-group">
				{!! Form::label('code', 'Code', ['class'=>'col-lg-2 col-md-2 col-sm-3 control-label']) !!} 
				<div class="col-lg-2 col-md-3 col-sm-6 @if($errors->first('code')) error @endif">
			...
			<div class="form-group">
				...
				<div class="col-lg-3 col-md-6 col-sm-6 @if($errors->first('name')) error @endif">
					{!! Form::text('name',null,['class'=>'form-control','name'=>'name', 'maxlength'=>'255']) !!}
			...
			<div class="form-group">
				{!! Form::label('anesthesia_base_unit', 'Anesthesia Base Unit', ['class'=>'col-lg-2 col-md-2 col-sm-3 control-label']) !!} 
				<div class="col-lg-2 col-md-3 col-sm-6 @if($errors->first('anesthesia_base_unit')) error @endif">
			...
			<div class="form-group">
				...
				<div class="col-lg-3 col-md-6 col-sm-6 @if($errors->first('status')) error @endif">
					{!! Form::radio('status', 'Active',true,['class'=>'','id'=>'mod2_active']) !!} {!! Form::label('mod2_active', 'Active',['class'=>'med-darkgray font600 form-cursor']) !!} &emsp;
                                        {!! Form::radio('status', 'Inactive',null,['class'=>'','id'=>'mod2_inactive']) !!} {!! Form::label('mod2_inactive', 'Inactive',['class'=>'med-darkgray font600 form-cursor']) !!}
		...
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
			...
			@if(strpos($currnet_page, 'edit') !== false)
				@if($checkpermission->check_url_permission('admin/modifierlevel2/delete/{id}'))
				<a class="btn btn-medcubics js-delete-confirm"data-text="Are you sure you want to delete?" href="{{ url('admin/modifierlevel2/delete/'.$modifiers->id) }}">Delete</a>
				@endif
				<a href="javascript:void(0)" data-url="{{url('admin/modifierlevel2/'.$modifiers->id)}}">{!! Form::button('Cancel', ['class'=>'btn btn-medcubics js_cancel_site']) !!}</a>
			@else
				<a href="javascript:void(0)" data-url="{{url('admin/modifierlevel2')}}">{!! Form::button('Cancel', ['class'=>'btn btn-medcubics js_cancel_site']) !!}</a>
			@endif
		</div>
