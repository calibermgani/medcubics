...
@section('toolbar')
	<div class="row toolbar-header">
		<section class="content-header">
			...
			<ol class="breadcrumb">
				<li><a href="javascript:void(0)" data-url="{{url('admin/modifierlevel2')}}" class="js_next_process"><i class="fa fa-reply" data-placement="bottom"  data-toggle="tooltip" data-original-title="Back"></i></a></li>
...
@section('practice')
	{!! Form::open(['url'=>'admin/modifierlevel2','id'=>'js-bootstrap-validator','name'=>'medcubicsform','class'=>'medcubicsform']) !!}
