...
@section('toolbar')
	<div class="row toolbar-header">
		<section class="content-header">
			<h1>
				<small class="toolbar-heading"><i class="fa {{Config::get('cssconfigs.common.modifiers')}}  font14"></i> Modifiers<i class="fa fa-angle-double-right med-breadcrum" data-name="angle-wide-right"></i> <span>View</span></small>
			</h1>
			@php $modifiers->id = App\Http\Helpers\Helpers::getEncodeAndDecodeOfId($modifiers->id,'encode'); @endphp
			<ol class="breadcrumb">
				<li><a href="{{ url('admin/modifierlevel2')}}"><i class="fa fa-reply" data-placement="bottom"  data-toggle="tooltip" data-original-title="Back"></i></a></li>
...
@section('practice')
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 margin-b-10 margin-t-10">                        
		@if($checkpermission->check_url_permission('admin/modifierlevel2/{modifierlevel2}/edit') == 1)
		<a href="{{ url('admin/modifierlevel2/'.$modifiers->id.'/edit')}}" class="font600 font14 pull-right margin-r-5"><i class="fa fa-edit" data-placement="bottom"  data-toggle="tooltip" data-original-title="Edit"></i> Edit</a>
		@endif
	</div>
	<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 space20"><!--  Right side Content Starts -->
		<div class="box box-view no-shadow"><!--  Box Starts -->
			<div class="box-header-view">
				<i class="livicon" data-name="Modifier"></i> <h3 class="box-title">Modifier Details</h3>
			...
			<div class="box-body"><!-- Box Body Starts -->
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 med-desc-bg">
					<div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
						<span class="med-green"> Code</span>
					</div>
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 med-desc-bg">
					<div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
						<span class="med-green"> Name</span>
					</div>
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 med-desc-bg">
					<div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
						<span class="med-green"> Description</span>
					</div>

					<div class="col-lg-9 col-md-9 col-sm-8 col-xs-12">
						<p>@if($modifiers->description == '')<span class="nill">- Nil - </span> @else {{ $modifiers->description }}@endif</p>
					</div>                               
				</div>

				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 med-desc-bg">
					<div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
						<span class="med-green"> Anesthesia Base Unit</span>
					</div>
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 med-desc-bg">
					<div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
						<span class="med-green"> Status</span>
					</div>
			...
			<div class="box-body table-responsive">
				<table class="table-responsive table-striped-view table">    
					<tbody>
						...
						<tr>
							<td>Updated On</td>
							<td>@if($modifiers->updated_at >='12-11-2015')<span class='bg-date'>{{ App\Http\Helpers\Helpers::dateFormat($modifiers->updated_at,'date')}}</span>@endif</td>
						</tr>
