        ...
        <ol class="breadcrumb">
			...
			@if(count($modifiers)>0)
				<li class="dropdown messages-menu hide"><a href ="" data-target="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-share-square-o" data-placement="bottom"  data-toggle="tooltip" data-original-title="Export"></i></a>
					@include('layouts.practice_module_export', ['url' => 'api/admin/modifierreports/'])
				</li>
			@endif
	...
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12  space20"><!-- Col Starts -->
		<div class="box box-info no-shadow"><!-- Box Starts Here -->
			<div class="box-header margin-b-10">
				<i class="fa fa-bars"></i> <h3 class="box-title">Modifier Level I List</h3>
				<div class="box-tools pull-right margin-t-2">
						@if($checkpermission->check_adminurl_permission('admin/modifierlevel1/create') == 1)
							<a href="{{ url('admin/modifierlevel1/create') }}" class="font600 font14"><i class="fa fa-plus-circle"></i> New Modifier</a>
						@endif	
				</div>
			</div><!-- /.box-header -->
			<div class="box-body">
					...
					<table id="example1" class="table table-bordered table-striped">
						...
						<tbody>
							@foreach($modifiers as $modifier)
								...
								<tr data-url="{{ url('admin/modifierlevel1/'.$modifier->id) }}" class="js-table-click clsCursor">            
									<td><center>{{ strtoupper($modifier->code) }}</center></td>
