<input type="hidden" class="js_set_confirm_msg" value='{{ trans("practice/practicemaster/confirmmessage.validation.admin.modifier1") }}' />
...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 space20" ><!-- Col Starts -->
	<div class="box box-info no-shadow"><!-- Box General Information Starts -->
		...
		<div class="box-body  form-horizontal margin-l-10"><!-- Box Body Starts -->
			...
			<div class="form-group">
				...
				<div class="col-lg-3 col-md-6 col-sm-6 @if($errors->first('status')) error @endif">
					{!! Form::radio('status', 'Active',true,['class'=>'','id'=>'mod1_active']) !!} {!! Form::label('mod1_active', 'Active',['class'=>'med-darkgray font600 form-cursor']) !!} &emsp;
                                        {!! Form::radio('status', 'Inactive',null,['class'=>'','id'=>'mod1_inactive']) !!} {!! Form::label('mod1_inactive', 'Inactive',['class'=>'med-darkgray font600 form-cursor']) !!}
		...
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
			...
			@if($checkpermission->check_url_permission('admin/modifierlevel1/delete/{id}') == 1 )
			<a class="btn btn-medcubics js-delete-confirm"data-text="Are you sure to delete the entry?" href="{{ url('admin/modifierlevel1/delete/'.$modifiers->id) }}">Delete</a>
			@endif
			<a href="javascript:void(0)" data-url="{{url('admin/modifierlevel1/'.$modifiers->id)}}">{!! Form::button('Cancel', ['class'=>'btn btn-medcubics js_cancel_site']) !!}</a>
			@else
			
			<a href="javascript:void(0)" data-url="{{url('admin/modifierlevel1')}}">{!! Form::button('Cancel', ['class'=>'btn btn-medcubics js_cancel_site']) !!}</a> 
			@endif
		</div>
