...
<div class="row-fluid">
    <div class="span12 navbar-fixed-top2 search-top">                  
        <div class="widget-title1 toolbar-band">                                            
            <div class="span8">
                <h3 class="toolbar-heading"><span><i class="fa {{Config::get('cssconfigs.common.modifiers')}}  font14"></i> Modifire List</span> </h3>
            </div>     
            ...
            <div class="span4 icon-space">
                <div class="fon">
                   <li><a href="javascript:void(0)" data-url="{{url('admin/modifierlevel1')}}" class="js_next_process"><i class="fa fa-reply" data-placement="bottom"  data-toggle="tooltip" data-original-title="Back"></i></a></li>
                    <span><a href="{{ url('modifierlevel1/create') }}"><i class="icon-plus-sign right1 tooltips" data-placement="bottom" data-toggle="tooltip" data-original-title="Add"></i></a></span>                       
