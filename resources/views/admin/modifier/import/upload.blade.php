...
<h1>
<small class="toolbar-heading">Modifiers - <span>Import</span></small>
</h1>
<ol class="breadcrumb">
	...
	<li><a href="#js-help-modal" data-url="{{url('help/modifiers')}}" class="js-help hide" data-toggle="modal"><i class="fa fa-question-circle" data-placement="bottom"  data-toggle="tooltip" data-original-title="Help"></i></a></li>
</ol>
</section>
...
@section('practice')
{!! Form::open(['url'=>'admin/importmodifiers','id'=>'js-bootstrap-validator','files'=>true]) !!}
