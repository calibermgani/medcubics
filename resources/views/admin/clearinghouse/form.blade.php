<input type="hidden" class="js_set_confirm_msg" value='{{ trans("practice/practicemaster/confirmmessage.validation.admin.edi") }}' />
	...
	<div class="box  no-shadow">
		...
		<div class="box-body form-horizontal margin-l-10"> 
			<div class="form-group">
				{!! Form::label('Practice Name', 'Practice Name', ['class'=>'col-lg-4 col-md-4 col-sm-4 col-xs-12 control-label']) !!}
				<div class="col-lg-7 col-md-7 col-sm-7 col-xs-10 @if($errors->first('practice_id')) error @endif">
					 {!! Form::select('practice_id', array(''=>'-- Select --')+(array)$practice_list, null, ['id'=>'practice_id','class' => 'form-control select2']) !!}
					{!! $errors->first('practice_id', '<p> :message</p>')  !!}
				</div>  
				<div class="col-md-1 col-sm-1 col-xs-2"> </div>
			</div>
			<div class="form-group">
				{!! Form::label('Name', 'Clearing House', ['class'=>'col-lg-4 col-md-4 col-sm-4 col-xs-12 control-label']) !!}
				<div class="col-lg-7 col-md-7 col-sm-7 col-xs-10 @if($errors->first('name')) error @endif">
					{!! Form::select('name', array(''=>'-- Select --')+['OfficeAlly' => 'OfficeAlly', 'Navicure' => 'Navicure'], null, ['id'=>'practice_id','class' => 'form-control select2']) !!}
			...
			<div class="form-group">
				{!! Form::label('Contact Name', 'Contact Name', ['class'=>'col-lg-4 col-md-4 col-sm-4 col-xs-12 control-label']) !!}
			...
			<div class="form-group">
				{!! Form::label('Contact Phone', 'Contact Phone', ['class'=>'col-lg-4 col-md-4 col-sm-4 col-xs-12 control-label']) !!}
			...
			<div class="form-group margin-t-10 margin-b-20">
				...
				<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 @if($errors->first('status')) error @endif">
					{!! Form::radio('status', 'Active',true,['class'=>'','id'=>'edi_active']) !!} {!! Form::label('edi_active', 'Active',['class'=>'med-darkgray font600 form-cursor']) !!} &emsp;
					{!! Form::radio('status', 'Inactive',null,['class'=>'','id'=>'edi_inactive']) !!} {!! Form::label('edi_inactive', 'Inactive',['class'=>'med-darkgray font600 form-cursor']) !!}
		...
		<div class="box-body form-horizontal margin-l-10 p-b-25">  
			<div class="form-group margin-t-10 margin-b-20">
				...
				<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 @if($errors->first('enable_eligibility')) error @endif">
					{!! Form::radio('enable_eligibility', 'Yes',null,['class'=>'js_status_change','data-valid'=>'eligibility','id'=>'e_yes']) !!} {!! Form::label('e_yes', 'Yes',['class'=>'med-darkgray font600 form-cursor']) !!} &emsp;
					{!! Form::radio('enable_eligibility', 'No',true,['class'=>'js_status_change','data-valid'=>'eligibility','id'=>'e_no']) !!} {!! Form::label('e_no', 'No',['class'=>'med-darkgray font600 form-cursor']) !!}
...
<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 margin-t-10"><!--  Right side Content Starts -->
	<div class="box no-shadow">
		<div class="box-block-header with-border">
		...
		<div class="box-body form-horizontal margin-l-10">
			<div class="form-group margin-t-10 margin-b-20">
				...
				<div class="col-lg-5 col-md-6 col-sm-6 col-xs-12 @if($errors->first('enable_837')) error @endif">
					{!! Form::radio('enable_837', 'Yes',true,['class'=>'js_status_change','data-valid'=>'enable_field','id'=>'ed_yes']) !!} {!! Form::label('ed_yes', 'Yes',['class'=>'med-darkgray font600 form-cursor']) !!} &emsp;
					{!! Form::radio('enable_837', 'No',null,['class'=>'js_status_change','data-valid'=>'enable_field','id'=>'ed_no']) !!} {!! Form::label('ed_no', 'No',['class'=>'med-darkgray font600 form-cursor']) !!}
					{!! $errors->first('enable_837', '<p> :message</p>')  !!}
				</div>                        
			</div> 

			<div class="form-group">
				{!! Form::label('Authorization Information - ISA01', 'Authorization Information - ISA01', ['class'=>'col-lg-6 col-md-6 col-sm-6 col-xs-12 control-label']) !!}
			...
			<div class="form-group">
				{!! Form::label('Submitter ID - ISA06', 'Submitter ID - ISA06', ['class'=>'col-lg-6 col-md-6 col-sm-6 col-xs-12 control-label']) !!}
			...
			<div class="form-group">
				{!! Form::label('Receiver ID - ISA08', 'Receiver ID - ISA08', ['class'=>'col-lg-6 col-md-6 col-sm-6 col-xs-12 control-label']) !!}
			...
			<div class="form-group">
				{!! Form::label('Acknowledgement Request - ISA14', 'Acknowledgement Request - ISA14', ['class'=>'col-lg-6 col-md-6 col-sm-6 col-xs-12 control-label']) !!}
			...
			<div class="form-group">
				{!! Form::label('Submission Mode - ISA15', 'Submission Mode - ISA15', ['class'=>'col-lg-6 col-md-6 col-sm-6 col-xs-12 control-label']) !!}
	...
	<div class="box no-shadow">
		...
		<div class="box-body form-horizontal margin-l-10">
			...
			<div class="form-group">
				{!! Form::label('FTP Address', 'FTP Address', ['class'=>'col-lg-4 col-md-4 col-sm-4 col-xs-12 control-label']) !!}
				<div class="col-lg-4 col-md-5 col-sm-7 col-xs-10 @if($errors->first('ftp_address')) error @endif">
					{!! Form::text('ftp_address',null,['id'=>'ftp_address','class'=>'form-control']) !!}
			 ...
			 <div class="form-group">
				...
				<div class="col-lg-4 col-md-5 col-sm-7 col-xs-10 @if($errors->first('ftp_address')) error @endif">
					{!! Form::text('ftp_port',(@$clearing_house->ftp_port == '')?'22':@$clearing_house->ftp_port,['id'=>'ftp_port','class'=>'form-control dm-agelimit']) !!}
					{!! $errors->first('ftp_port', '<p> :message</p>')  !!}
				</div>                        
			</div>
			
			<div class="form-group">
				{!! Form::label('User ID', 'User ID', ['class'=>'col-lg-4 col-md-4 col-sm-4 col-xs-12 control-label']) !!}
				<div class="col-lg-4 col-md-5 col-sm-7 col-xs-10 @if($errors->first('ftp_user_id')) error @endif">
					{!! Form::text('ftp_user_id',null,['id'=>'ftp_user_id','class'=>'form-control','maxlength'=>20]) !!}
			...
			<div class="form-group">
				...
				<div class="col-lg-4 col-md-5 col-sm-7 col-xs-10 @if($errors->first('ftp_password')) error @endif">
					{!! Form::text('ftp_password',null,['id'=>'ftp_password','class'=>'form-control','maxlength'=>20]) !!}
					{!! $errors->first('ftp_password', '<p> :message</p>')  !!}
				</div>                        
			</div>
			<div class="form-group">
				{!! Form::label('Upload Path', 'Upload Path', ['class'=>'col-lg-4 col-md-4 col-sm-4 col-xs-12 control-label']) !!}
				<div class="col-lg-4 col-md-5 col-sm-7 col-xs-10 @if($errors->first('ftp_folder')) error @endif">
					{!! Form::text('ftp_folder',null,['id'=>'ftp_folder','class'=>'form-control']) !!}
					{!! $errors->first('ftp_folder', '<p> :message</p>')  !!}
				</div>                        
			</div>
			<div class="form-group">
				{!! Form::label('Download Path', 'Download Path', ['class'=>'col-lg-4 col-md-4 col-sm-4 col-xs-12 control-label']) !!}
				<div class="col-lg-4 col-md-5 col-sm-7 col-xs-10 @if($errors->first('edi_report_folder')) error @endif">
					{!! Form::text('edi_report_folder',null,['id'=>'edi_report_folder','class'=>'form-control']) !!}
			...
			<div class="margin-b-20 hidden-sm hidden-xs">&emsp;</div>
			<div class="margin-b-25 hidden-sm hidden-xs">&emsp;</div>
...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
	...
	@if(strpos($currnet_page, 'edit') !== false)                
		@if($checkpermission->check_adminurl_permission('admin/edi/delete/{id}') == 1)
			<a class="btn btn-medcubics js-delete-confirm" data-text="Are you sure would you like to delete?" href="{{ url('admin/edi/delete/'.$clearing_house->id) }}">Delete</a>
		@endif
		
		<a href="javascript:void(0)" data-url="{{ url('admin/edi/'.$clearing_house->id)}}">{!! Form::button('Cancel', ['class'=>'btn btn-medcubics js_cancel_site']) !!}</a>
	@else
		<a href="javascript:void(0)" data-url="{{ url('admin/edi')}}">{!! Form::button('Cancel', ['class'=>'btn btn-medcubics js_cancel_site']) !!}</a>
	@endif 
</div>
...
<script type="text/javascript">
    $(document).ready(function() {
		...
		$(document).on('ifToggled click', '.js_status_change:checked', function () {
			...
			//$('#js-bootstrap-validator:not(".js_eligibility").data("bootstrapValidator").resetForm();
			//$('#js-bootstrap-validator:not(".js_eligibility")').bootstrapValidator('validate');
            ...
            .bootstrapValidator({
                ...
                fields: {
					...
					contact_fax: {
						...
						validators: {
							/*notEmpty: {
								message: '{{ trans("common.validation.fax") }}'
							},*/
							callback: {
								message: '',
								callback: function (value, validator) {
					...
					ftp_folder: {
						...
						validators: {
							...
							callback: {
								message: '{{ trans("admin/clearinghouse.validation.folder_regex") }}',
								callback: function (value, validator) {
