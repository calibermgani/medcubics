...
<div class="row toolbar-header">
    ...
    <section class="content-header">
        <h1>
            <small class="toolbar-heading"><i class="fa {{Config::get('cssconfigs.Practicesmaster.user')}} med-breadcrum med-green"></i> Tickets <i class="fa fa-angle-double-right med-breadcrum" data-name="angle-wide-right"></i> Updates <i class="fa fa-angle-double-right med-breadcrum" data-name="angle-wide-right"></i>  <span> View </span></small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="{{url('admin/updates')}}" ><i class="fa fa-reply" data-placement="bottom"  data-toggle="tooltip" data-original-title="Back"></i></a></li>
                    ...
                    <div class="box-body table-responsive">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 no-padding">
                            ...
                            <h3>{{  ucwords($blog->title) }}
								...
								@if($checkpermission->check_url_permission('admin/updates/{blog}/edit') == 1)	
									@if($blog->user_id == Auth::user()->id)
									<a href="{{ url('admin/updates/'.$blog_id.'/edit') }}" class="med-green font14 pull-right"><i class="fa fa-edit"></i> Edit</a>
                            ...
                            <p class="med-gray">@if($blog->attachment!='')
                                @if($ext == 'jpg' || $ext == 'jpeg' || $ext == 'png' || $ext == 'gif' ) 
									<a class="" style="border-right:1px solid #ccc; padding-right: 8px; padding-left: 4px;" href="#" onClick="window.open('{{ url('admin/updates/getattachment/'.$blog_id) }}', '_blank')" >View Attachment</a>
                                @else 
