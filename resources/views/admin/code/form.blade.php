<input type="hidden" class="js_set_confirm_msg" value='{{ trans("practice/practicemaster/confirmmessage.validation.admin.codes") }}' />

		<div class="col-md-12 col-md-12 col-sm-12 col-xs-12" >
			<div class="box box-info no-shadow">
				<div class="box-block-header margin-b-10">
				<h3 class="box-title"><i class="livicon" data-name="code" data-color='#008e97' data-size='16'></i> Code Details</h3>
				...
				<div class="box-body  form-horizontal margin-t-10 margin-l-10">
					<div class="form-group">
					  {!! Form::label('CodeCategory', 'Code Category', ['class'=>'col-lg-3 col-md-4 col-sm-4 col-xs-12 control-label']) !!}
					...
					<div class="form-group">
						{!! Form::label('TransactionCode', 'Transaction Code', ['class'=>'col-lg-3 col-md-4 col-sm-4 col-xs-12 control-label']) !!}
					...
					<div class="form-group">
						{!! Form::label('Description', 'Description', ['class'=>'col-lg-3 col-md-4 col-sm-4 col-xs-12 control-label']) !!}
						<div class="col-lg-3 col-md-3 col-sm-6 col-xs-10 @if($errors->first('description')) error @endif">
					...
					<?php $code->start_date= ($code->start_date!='0000-00-00')? date("m/d/Y",strtotime($code->start_date)):''; ?>
					<?php $code->last_modified_date= ($code->last_modified_date!='0000-00-00')? date("m/d/Y",strtotime($code->last_modified_date)):''; ?>
					@endif
					<div class="form-group">
						...
						<div class="col-sm-1"></div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-5 col-md-5 col-sm-6 col-xs-6 @if($errors->first('status')) error @endif">
                                                {!! Form::radio('status', 'Active',true,['class'=>'','id'=>'c_active']) !!} {!! Form::label('c_active', 'Active',['class'=>'med-darkgray font600 form-cursor']) !!} &emsp;
                                                {!! Form::radio('status', 'Inactive',null,['class'=>'','id'=>'c_inactive']) !!} {!! Form::label('c_inactive', 'Inactive',['class'=>'med-darkgray font600 form-cursor']) !!}
