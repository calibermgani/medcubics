...
<div class="row toolbar-header">
    ...
    <section class="content-header">
        <h1>
            <small class="toolbar-heading"><i class="fa {{Config::get('cssconfigs.common.insurance')}}  font14"></i> Insurance <i class="fa fa-angle-double-right med-breadcrum" data-name="angle-wide-right"></i> <span>Edit Insurance</span></small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="javascript:void(0)" data-url="{{ url('admin/insurance/'.$insurance->id) }}" class="js_next_process"><i class="fa fa-reply" data-placement="bottom"  data-toggle="tooltip" data-original-title="Back"></i></a></li>
...
{!! Form::model($insurance, ['method'=>'PATCH','id'=>'js-bootstrap-validator','name'=>'myform','role' => 'form','action' => '', 'files' => true ,'url'=>'admin/insurance/'.$insurance->id,'class'=>'medcubicsform']) !!}
                    ...
                    <div class="fileupload fileupload-new" data-provides="fileupload">
                        <div class="fileupload-new thumbnail">
							...
							@if($insurance->avatar_name == '')
								<img class="js_default_img"  src="{{ URL('/img/insurance-avator.jpg')}}">	
							@else
								{!! $image_tag !!}  
							@endif
							</div>
