...
<?php $insurance->id = App\Http\Helpers\Helpers::getEncodeAndDecodeOfId($insurance->id,'encode'); ?>
    <section class="content-header">
        <h1>
            <small class="toolbar-heading"><i class="fa {{Config::get('cssconfigs.common.insurance')}}" data-name="bank"></i>Insurance <i class="fa fa-angle-double-right med-breadcrum" data-name="angle-wide-right"></i> Appeal Address <i class="fa fa-angle-double-right med-breadcrum" data-name="angle-wide-right"></i> <span>New Appeal Address</span></small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="javascript:void(0)" data-url="{{ url('admin/insurance/'.$insurance->id.'/insuranceappealaddress') }}" class="js_next_process"><i class="fa fa-reply" data-placement="bottom"  data-toggle="tooltip" data-original-title="Back"></i></a></li>
...
@stop
    ...
    {!! Form::open(['url'=>'admin/insurance/'.$insurance->id.'/insuranceappealaddress','class'=>'insurance-info-form','id'=>'js-bootstrap-validator','name'=>'medcubicsform','class'=>'medcubicsform']) !!}
