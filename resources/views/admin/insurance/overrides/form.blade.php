            ...
            <div class="box box-info no-shadow">
                ...
                <div class="box-body  form-horizontal margin-l-10">
                    ...
                    <div class="form-group">
                        {!! Form::label('insurance', 'Facility',  ['class'=>'col-lg-2 col-md-2 col-sm-3 col-xs-12 control-label']) !!} 
                        <div class="col-lg-3 col-md-6 col-sm-6 col-xs-10 @if($errors->first('facility_id')) error @endif">
                    ...
                    <div class="form-group">
                        {!! Form::label('billing_provider', 'Provider', ['class'=>'col-lg-2 col-md-2 col-sm-3 col-xs-12 control-label']) !!} 
                    ...
                    <div class="form-group">
                       {!! Form::label('tax_id', 'Tax ID', ['class'=>'col-lg-2 col-md-2 col-sm-3 col-xs-12 control-label']) !!} 
                        <div class="col-lg-2 col-md-5 col-sm-6 col-xs-10">
                    ...
                    <div class="form-group">
                        {!! Form::label('npi', 'NPI', ['class'=>'col-lg-2 col-md-2 col-sm-3 col-xs-12 control-label']) !!} 
                        <div class="col-lg-2 col-md-5 col-sm-6 col-xs-10 @if($errors->first('conversion_factor')) error @endif">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 @if($errors->first('provider_id')) error @endif">
                            {!! Form::text('provider_id',null,['class'=>'form-control dm-medicare','name'=>'provider_id']) !!}
                    ...
                    <div class="form-group">
                        {!! Form::label('id type', 'ID Type', ['class'=>'col-lg-2 col-md-2 col-sm-3 col-xs-12 control-label']) !!} 
                        <div class="col-lg-3 col-md-6 col-sm-6 col-xs-10 @if($errors->first('id_qualifiers_id')) error @endif">
                ...
                @if(strpos($currnet_page, 'edit') !== false && $checkpermission->check_adminurl_permission('admin/insurance/{insuranceid}/insuranceoverrides/delete/{id}') == 1)
						
                        <a class="btn btn-medcubics js-delete-confirm"data-text="Are you sure you want to delete?" 
   href="{{ url('admin/insurance/'.$insurance->id.'/insuranceoverrides/delete/'.$overrides->id) }}">Delete</a>
                
              
               <a href="javascript:void(0)" data-url="{{ url('admin/insurance/'.$insurance->id.'/insuranceoverrides/'.$overrides->id) }}">{!! Form::button('Cancel', ['class'=>'btn btn-medcubics js_cancel_site']) !!}</a>
						@endif
                                                
                  @if(strpos($currnet_page, 'edit') == false)
                     <a href="javascript:void(0)" data-url="{{ url('admin/insurance/'.$insurance->id.'/insuranceoverrides/') }}">{!! Form::button('Cancel', ['class'=>'btn btn-medcubics js_cancel_site']) !!}</a>   
                          @endif
...
$(document).ready(function() {
  $('#js-bootstrap-validator')
	...
	facility_id:{
                ...
                validators:{
                    notEmpty:{
                        message: '{{ trans("admin/insurance.validation.facility_id") }}'
                   	}
                }
            },
            insurances_id:{
                ...
                validators:{
                    notEmpty:{
                        message: '{{ trans("admin/insurance.validation.insurances_id") }}'
                   	}
                }
            },
			 providers_id:{
			...
			provider_id:{
                ...
                validators:{
                    notEmpty:{
                        message: '{{ trans("admin/insurance.validation.provider_id") }}'
                   	},
                    regexp:{
                        	regexp: /^[0-9]{0,15}$/,
                        	message: '{{ trans("admin/insurance.validation.provider_regex") }}'
                   	}
                }
            },
			 ...
			 id_qualifiers_id:{
                ...
                validators:{
                    notEmpty:{
                        message: '{{ trans("admin/insurance.validation.type_id") }}'
                   	}
                }
            },
