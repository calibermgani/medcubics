...
<div class="row toolbar-header">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            <li><a href="{{ url('statementholdreason')}}"><i class="fa {{Config::get('cssconfigs.common.back')}}" data-placement="bottom"  data-toggle="tooltip" data-original-title="Back"></i></a></li>
...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 margin-t-10 margin-b-10">
    @if($checkpermission->check_url_permission('statementholdreason/{statementholdreason}/edit') == 1)
    <a href="{{ url('statementholdreason/'.$statementholdreason->id.'/edit')}}" class=" pull-right font14 font600 margin-r-5"><i class="fa {{Config::get('cssconfigs.common.edit')}}"></i> Edit</a>
    @endif	
</div>
    ...
    <div class="box box-info no-shadow"><!-- General Info Box Starts -->
        ...
        <div class="box-body form-horizontal margin-l-10"> 
			...
			<div class="form-group">
                {!! Form::label('hold_reason', 'Statement Hold Reason', ['class'=>'col-lg-2 col-md-2 col-sm-4 col-xs-12 control-label']) !!}  
                <div class="col-lg-4 col-md-5 col-sm-8 col-xs-12">
                    ...
                    <p class="show-border no-bottom">{{ $statementholdreason->hold_reason }}</p>	
            ...
            <div class="form-group">
                ...
                <div class="col-lg-8 col-md-7 col-sm-8 col-xs-9">  
					@if($statementholdreason->status == 'Active')
            ...
            <div class="form-group">
                ...
                <div class="col-lg-3 col-md-4 col-sm-8 col-xs-12">
                    <p class="show-border no-bottom">@if($statementholdreason->created_by != ''){{ App\Http\Helpers\Helpers::shortname($statementholdreason->created_by) }} @endif</p>						
                </div>                
            </div> 
            ...
            <div class="form-group">
                ...
                <div class="col-lg-2 col-md-3 col-sm-8 col-xs-12">
                    <p class="show-border no-bottom">@if($statementholdreason->created_at !='' && $statementholdreason->created_at !='-0001-11-30 00:00:00' && $statementholdreason->created_at !='0000-00-00 00:00:00')
                        {{ App\Http\Helpers\Helpers::dateFormat($statementholdreason->created_at, 'date') }}
                        @endif</p>						
                </div>                
            </div> 
            
            @if(@$statementholdreason->updated_by != '')
            <div class="form-group">
                {!! Form::label('Updated By', 'Updated By', ['class'=>'col-lg-2 col-md-2 col-sm-4 col-xs-12 control-label']) !!}
                <div class="col-lg-3 col-md-4 col-sm-8 col-xs-12">
                    <p class="show-border no-bottom">{{ App\Http\Helpers\Helpers::shortname($statementholdreason->updated_by) }}</p>
                </div>                
            </div>
            @endif
            
            @if($statementholdreason->updated_at !='' && $statementholdreason->updated_at !='-0001-11-30 00:00:00' && $statementholdreason->updated_at !='0000-00-00 00:00:00')
            <div class="form-group">
                {!! Form::label('Updated On', 'Updated On', ['class'=>'col-lg-2 col-md-2 col-sm-4 col-xs-12 control-label']) !!}   						
                <div class="col-lg-2 col-md-3 col-sm-8 col-xs-12">
                    <p class="show-border no-bottom">
                        {{ App\Http\Helpers\Helpers::dateFormat($statementholdreason->updated_at, 'date') }}
                    </p>
                </div>                
            </div>
            @endif
