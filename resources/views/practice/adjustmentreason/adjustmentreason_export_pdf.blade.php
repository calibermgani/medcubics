    ...
    <body>
        ...
        <div class="header">
            <table style="padding: 0px 0px; margin-top: 0px;">
                ...
                <tr style="line-height:8px;">
                    <td style="line-height:8px;"><p class="text-center" style="font-size:13px !important;"><i>Adjustment Reason</i></p></td>
                </tr>
            </table>
                        ...
                        <tr>
                            ...
                            <td>
                                @if($adjustment->updated_by !='' && $adjustment->updated_by !='0')
                                    {{ App\Http\Helpers\Helpers::timezone($adjustment->updated_at, 'm/d/y') }}
                                @endif
                            </td>
                        </tr>
                        @endforeach
