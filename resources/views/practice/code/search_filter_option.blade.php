{!! Form::open(['url'=>'code/search','id'=>'js_common_search_form','name'=>'search_form']) !!}
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 margin-t-10">
        <div class="no-shadow form-horizontal">
			<div class="col-lg-4 col-md-5 col-sm-12 col-xs-12 no-padding"> 
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 no-padding"> 
					<div class="form-group-billing">
						{!! Form::label('Code', 'Code Category',['class'=>'col-lg-4 col-md-4 col-sm-6 col-xs-12 control-label']) !!} 
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-10">
						{!! Form::text('codecategory_id',null,['class'=>'form-control input-sm-header-billing']) !!}
						</div>
					</div>
				</div>
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 no-padding"> 
					<div class="form-group-billing">
						{!! Form::label('name', 'Trans Code',  ['class'=>'col-lg-4 col-md-4 col-sm-6 col-xs-12 control-label']) !!} 
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-10">
			...
			<div class="col-lg-4 col-md-5 col-sm-12 col-xs-12 no-padding"> 
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 no-padding"> 
					<div class="form-group-billing">
						{!! Form::label('description', 'Description',['class'=>'col-lg-4 col-md-4 col-sm-6 col-xs-12 control-label']) !!} 
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-10">
