...
<html lang="en">
    ...
    <body>
        ...
        <table>
            ...
            <tr>
                <td colspan="4" style="text-align:center;">Modifier Level II List</td>
            </tr>
            <tr>
        ...
        <table>
            <thead>
                <tr>
                    <th valign="center" style="text-align:center;border-bottom: 2px solid  #000!important;font-weight: 800;font-size:12px;width:15px;">Modifiers</th>	
                    <th valign="center" style="text-align:center;border-bottom: 2px solid  #000!important;font-weight: 800;font-size:12px;width:15px;">Name</th>
            ...
            <tbody>
                ...
                <tr>
                    <td class="text-center">{{ $modifier->code }}</td>
                    <td>{{ $modifier->name }}</td>
