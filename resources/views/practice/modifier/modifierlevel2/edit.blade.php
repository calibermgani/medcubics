@extends('admin')
	...
	<div class="row toolbar-header">
		...
		<?php $modifiers->id = App\Http\Helpers\Helpers::getEncodeAndDecodeOfId($modifiers->id,'encode'); ?>
			...
			<ol class="breadcrumb">
				<li><a  href="javascript:void(0)" data-url="{{url('modifierlevel2/'.$modifiers->id)}}" class="js_next_process"><i class="fa {{Config::get('cssconfigs.common.back')}}" data-placement="bottom"  data-toggle="tooltip" data-original-title="Back"></i></a></li>
...
@section('practice')
	{!! Form::model($modifiers, ['method'=>'PATCH', 'url'=>'modifierlevel2/'.$modifiers->id,'id'=>'js-bootstrap-validator','name'=>'medcubicsform','class'=>'medcubicsform']) !!}
		@include ('practice/modifier/modifierlevel2/form',['submitBtn'=>'Save'])
	{!! Form::close() !!}
@stop            