...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 margin-b-10 margin-t-10">
    @if($checkpermission->check_url_permission('modifierlevel1/{modifierlevel1}/edit') == 1)
    <a href="{{ url('modifierlevel1/'.$modifiers->id.'/edit')}}" class="font600 font14 pull-right margin-r-5"><i class="fa {{Config::get('cssconfigs.common.edit')}}"></i> Edit</a>
    @endif	
</div>
    ...
    <div class="box box-info no-shadow"><!-- Box General Information Starts -->
        ...
        <div class="box-body  form-horizontal margin-l-10"><!-- Box Body Starts -->
            ...
            <div class="form-group">
                ...
                <div class="col-lg-2 col-md-3 col-sm-6 col-xs-10">
                    <p class="show-border no-bottom">@if($modifiers->updated_by  !=''){{ App\Http\Helpers\Helpers::dateFormat($modifiers->updated_at,'date')}} @endif</p>
                </div>
                <div class="col-sm-1"></div>
            </div>
