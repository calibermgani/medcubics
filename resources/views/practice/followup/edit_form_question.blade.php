        ...
        <div class="box-body  form-horizontal margin-l-10"><!-- Box Body Starts -->
			<div class="form-group">
                ...
                <div class="col-lg-2 col-md-3 col-sm-6 col-xs-10 @if($errors->first('code')) error @endif">
                   {!! Form::select('category', array('' => '-- Select --') + (array)$category,  $question[0]->category_id,['class'=>'form-control select2']) !!}
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-2 col-md-3 col-sm-6 col-xs-10 @if($errors->first('code')) error @endif">
                    {!! Form::text('question',$question[0]->question,['class'=>'form-control','name'=>'question']) !!}
			...
			<div class="form-group">
                ...
                <div class="col-lg-2 col-md-3 col-sm-6 col-xs-10 @if($errors->first('code')) error @endif">
                   {!! Form::select('field_type', array('' => '-- Select --') + (array)$filed_type,  $question[0]->field_type,['class'=>'form-control select2']) !!}
                </div>
                <div class="col-sm-1"></div>
            </div>
			...
			<div class="form-group hide" id="date_type">
                ...
                <div class="col-lg-2 col-md-3 col-sm-6 col-xs-10 @if($errors->first('code')) error @endif">
                   {!! Form::select('date_type', array('' => '-- Select --') + (array)$date_type,  $question[0]->date_type,['class'=>'form-control select2']) !!}
                </div>
                <div class="col-sm-1"></div>
            </div>
			...
			<div class="form-group hide" id="field_validation">
                ...
                <div class="col-lg-2 col-md-3 col-sm-6 col-xs-10 @if($errors->first('code')) error @endif">
                   {!! Form::select('field_validation', array('' => '-- Select --') + (array)$filed_validation,  $question[0]->field_validation,['class'=>'form-control select2']) !!}
                </div>
                <div class="col-sm-1"></div>
            </div>
