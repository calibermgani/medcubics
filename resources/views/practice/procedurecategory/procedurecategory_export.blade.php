...
<html lang="en">
    <head>
        <title>Procedure Category</title>
        <style>
            table tbody tr  td{
    ...
    <body>
        ...
        <table>
            ...
            <tr>
                <td colspan="6" style="text-align:center;">Procedure Category List</td>
            </tr>
            <tr>
        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th valign="center" style="text-align:center;border-bottom: 2px solid  #000!important;font-weight: 800;font-size:12px;width:15px;">Procedure Category</th>
