...
@section('practice')
	{!! Form::model($procedurecategory, ['method'=>'PATCH','id'=>'js-bootstrap-validator','name'=>'myform','role' => 'form','action' => '', 'files' => true ,'url'=>'procedurecategory/'.$procedurecategory_id,'class'=>'medcubicsform']) !!} 
