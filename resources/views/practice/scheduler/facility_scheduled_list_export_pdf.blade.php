    ...
    <body>
        ...
        <div class="header">
            <table style="padding: 0px 0px; margin-top: 0px;">
                ...
                <tr style="line-height:8px;">
                    <td style="line-height:8px;"><p class="text-center" style="font-size:13px !important;"><i>Facility Scheduled List</i></p></td>
                </tr>
            </table>
                ...
                <table style="overflow: hidden;border-spacing: 0px; font-weight:normal;width: 98%; padding-left: 10px;border-collapse: collapse !important;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-left">@if($all_facility_scheduler->end_date_option == 'after'){{$all_facility_scheduler->no_of_occurrence}}@else -- @endif</td>
