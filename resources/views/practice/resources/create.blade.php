...
<div class="row toolbar-header">
    <section class="content-header">
        <h1>
            <small class="toolbar-heading"><i class="fa {{Config::get('cssconfigs.Practicesmaster.resources')}} font14"></i> Resources <i class="fa fa-angle-double-right med-breadcrum" data-name="angle-wide-right"></i> <span>New Resource</span></small>
        </h1>
        <ol class="breadcrumb">
...
@section('practice')
{!! Form::open(['url'=>'resources','id'=>'js-bootstrap-validator']) !!}   
