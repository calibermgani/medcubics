...
<div class="row toolbar-header">
	<?php $id = App\Http\Helpers\Helpers::getEncodeAndDecodeOfId($insurancetypes->id,'encode'); ?>
    <section class="content-header">
        ...
        <ol class="breadcrumb">
			<li><a href="javascript:void(0)" data-url="{{url('insurancetypes/'.$id)}}" class="js_next_process"><i class="fa fa-reply" data-placement="bottom"  data-toggle="tooltip" data-original-title="Back"></i></a></li>
...
@stop
@section('practice')	
	{!! Form::model($insurancetypes, ['method'=>'PATCH', 'url'=>'insurancetypes/'.$id,'id'=>'js-bootstrap-validator','name'=>'medcubicsform','class'=>'medcubicsform']) !!}
		@include ('practice/insurancetypes/form',['submitBtn'=>'Save'])
	{!! Form::close() !!}
@stop            