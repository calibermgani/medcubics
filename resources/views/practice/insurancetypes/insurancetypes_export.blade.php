...
<html lang="en">
    ...
    <body>
        ...
        <table>
            ...
            <tr>
                <td colspan="6" style="text-align:center;">Insurance Types List</td>
            </tr>
            <tr>
        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th valign="center" style="text-align:center;border-bottom: 2px solid  #000!important;font-weight: 800;font-size:12px;width:15px;">CMS Type</th>
