...
<div class="row toolbar-header">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            <li><a href="javascript:void(0)" data-url="{{url('facility/'.$facility->id.'/facilitydocument')}}" class="js_next_process"><i class="fa {{Config::get('cssconfigs.common.back')}}" data-placement="bottom"  data-toggle="tooltip" data-original-title="Back"></i></a></li>
...
@section('practice')
@include ('practice/practice/document/practice_document_form',['document_type'=>'facility']) 
@stop            