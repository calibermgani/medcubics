...
@section('practice')
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 margin-t-10 margin-b-10">
       @if($checkpermission->check_url_permission('provider/{provider_id}/providerdocuments/create') == 1)
       <a href="{{ url('provider/'.$provider->id.'/providerdocuments/create')}}" class="pull-right font600 font14"><i class="fa {{Config::get('cssconfigs.common.plus_circle')}}"></i> New Document</a>
		@endif	
    </div>
    
	@include ('practice/practice/document/practice_document_table',['document_type'=>'provider'])  
@stop            