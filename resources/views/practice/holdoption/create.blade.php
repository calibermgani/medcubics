...
<div class="row toolbar-header"><!-- Toolbar Row Starts -->
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            <li><a href="javascript:void(0)" data-url="{{ url('holdoption') }}" class="js_next_process"><i class="fa {{Config::get('cssconfigs.common.back')}}" data-placement="bottom"  data-toggle="tooltip" data-original-title="Back"></i></a></li>
...
@section('practice')
	{!! Form::open(['url'=>'holdoption','id'=>'js-bootstrap-validator','name'=>'medcubicsform','class'=>'medcubicsform']) !!}   
