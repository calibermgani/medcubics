...
<div class="row toolbar-header"><!-- Toolbar Row Starts -->
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            <li><a href="javascript:void(0)" data-url="{{ url('questionnaires') }}" class="js_next_process"><i class="fa {{Config::get('cssconfigs.common.back')}}" data-placement="bottom"  data-toggle="tooltip" data-original-title="Back"></i></a></li>
...
@stop
@section('practice')
{!! Form::open(['url'=>'questionnaires','id'=>'js-bootstrap-validator','name'=>'medcubicsform','class'=>'js-set-questionaire medcubicsform']) !!}   
