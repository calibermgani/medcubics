...
window.webcam = {
	...
	swf_url: api_site_url+'/js/webcam/webcam.swf', // URI to webcam.swf movie (defaults to cwd)
	shutter_url: api_site_url+'/js/webcam/shutter.mp3', // URI to shutter.mp3 sound
	api_url: '', // URL to upload script
	//api_url: 'http://localhost/revathi/14-12/public/js/webcam/upload.php', // URL to upload script
	...
	get_html: function(width, height, server_width, server_height) { 
		...
		if (this.ie) {
			...
			//alert("It appears that Flash is being blocked. Please enable it and refresh the page");
			//html += '<div style="margin:150px;position:absolute;display:none" id="webcam_div"><embed id="webcam_movie" src="'+this.swf_url+'" loop="false" menu="false" quality="best" bgcolor="#ffffff" width="'+width+'" height="'+height+'" name="webcam_movie" align="middle" allowScriptAccess="always" allowFullScreen="false" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" flashvars="'+flashvars+'" /></div>';
		}
	...
	set_shutter_sound: function(enabled, url) {
		...
		this.shutter_url = url ? url : api_site_url+'/js/webcam/shutter.mp3';
	},
