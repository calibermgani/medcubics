...
use Lang;
class PracticeManagecare extends Model 
{

	use SoftDeletes;
	protected $dates 	= ['deleted_at'];
    protected $table 	= 'practicemanagecares';
	protected $fillable = ['insurance_id','enrollment','entitytype','provider_id', 'providers_id','effectivedate','terminationdate', 'feeschedule'];
    ...
    public static function getUsedInsuranceid()
	{
		return $insurance_name = Practicemanagecare::groupBy('insurance_id')->pluck('insurance_id')->all();
	}    
}