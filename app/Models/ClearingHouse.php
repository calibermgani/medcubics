...
class ClearingHouse extends Model {
	...
	public function practice_details()
    {
    ...
    public static function rules($request){
		$rules = [
			...
			'contact_phone' => 	'nullable|Regex:/\(?[0-9]{3}\)?[-. ]?[0-9]{3}[-. ]?[0-9]{4}/',
			'contact_fax' 	=> 	'nullable|Regex:/\(?[0-9]{3}\)?[-. ]?[0-9]{3}[-. ]?[0-9]{4}/',
	...
	public static function messages(){
		return [
			...
			'eligibility_web_service_url.required' 	=> trans("admin/clearinghouse.validation.web_url"),
