...
class ArManagementController1 extends Api\ArManagementApiController1 {

	public function __construct()
	{
    	View::share('heading', 'AR Mangmnt');
        View::share('selected_tab', 'armanagement');
        View::share('heading_icon', 'fa-wheelchair');        	
	}
	...
	{		
		...
		if($api_response_data->status == 'success')	
		{
		    ...
		    return view ( 'patients/armanagement1/armanagement', compact ('claims_lists', 'patient_id','patient_tabs_details','patient_tabs_insurance_details','patient_tabs_insurance_count') );
		}
		else
		{
	...
	{		
		...
		if($api_response_data->status == 'success')	
		{
		    ...
		    return view ( 'patients/armanagement1/list', compact ('claims_lists', 'patient_id','patient_tabs_details','patient_tabs_insurance_details','patient_tabs_insurance_count') );
		}
		else
		{
            return Redirect::to('/patients');
	...
	{		
		...
		if($api_response_data->status == 'success')	
		{
		    ...
		    return view ( 'patients/armanagement1/view', compact ('claims_lists', 'patient_id','patient_tabs_details','rendering_providers','billing_providers','facilities','providers','patient_tabs_insurance_details','patient_tabs_insurance_count') );
		}
		else
		{
            return Redirect::to('/patients');
	...
	public function create($patient_id, $claim_id=null)
	{
        ...
        $billing_provider_id = '';
        $insurance_id = '';
        $view = 'patients/armanagement1/create';
	...
	{ 
        ...
        if ($api_response_data->status == 'success') {
        	...
        	/*****Redirection for E-superbill batches starts******/
          	...
          	{
      			$patient_id = ClaimInfoV1::where('id', $request['next_id'])->pluck('patient_id')->first();
