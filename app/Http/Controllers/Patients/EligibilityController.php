...
use Validator;
use Config;
use App\Http\Controllers\Api\EligibilityApiController as EligibilityApiController;
use App\Models\Patient;

class EligibilityController extends Api\EligibilityApiController {

	public function __construct()
	{
		View::share ( 'heading', 'Eligibility' );
		View::share ( 'selected_tab', 'eligibility' );
		View::share( 'heading_icon', Config::get('cssconfigs.admin.speciality'));
	}
	/**
	...
	{	
		...
		return view ( 'patients/eligibility/eligibility', compact ( 'patients') );
	}
	/**
	...
	public function create()
	{
            ...
            return view ( 'patients/patients/create', compact ('patients','facilities', 'insurances', 'address_flag','facility_id','providers','provider_id','insurance_id','rendering_providers','rendering_provider_id','referring_providers','referring_provider_id','patient_language','language_id','ethnicity','ethnicity_id','religion','religion_id','state','state_id') );
	}
	...
	{ 
        ...
        if($api_response_data->status == 'success')
            {
                return Redirect::to('patients/'.$api_response_data->data.'/edit#insurance-info')->with('success', $api_response_data->message);
            }
        else
            {
...
return view('patients/patients/show', compact('patients','address_flag','language','language_id','ethnicity','ethnicity_id','religion','religion_id','facility','facility_id','insurance','insurance_id','insuranceclass','insuranceclass_id','insurancetype','insurancetype_id'));		
	}
...
return view('patients/patients/show1', compact('patients','address_flag','language','language_id','ethnicity','ethnicity_id','religion','religion_id','facility','facility_id','insurance','insurance_id','insuranceclass','insuranceclass_id','insurancetype','insurancetype_id'));		
	}
...
return view('patients/patients/show2', compact('patients','address_flag','language','language_id','ethnicity','ethnicity_id','religion','religion_id','facility','facility_id','insurance','insurance_id','insuranceclass','insuranceclass_id','insurancetype','insurancetype_id'));		
	}
	...
	{ 	
		...
		if($api_response_data->status == 'success')
		{ 
			echo "success~~".Request::input('next_tab_name'); exit;
		}
		else
		{ 
			echo "error"; exit;
