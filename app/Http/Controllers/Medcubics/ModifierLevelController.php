...
class ModifierLevelController extends Api\ModifierLevelApiController 
{
	...
	public function index()
	{
		...
		return view ( 'admin/modifier/modifierlevel2/modifier', compact ( 'modifiers') );
	...
	public function create()
	{
		...
		return view('admin/modifier/modifierlevel2/create',  compact('modifierstype','modifiers_type_id'));
	}
	/*** Create page Ends ***/
	...
	public function store(Request $request)
	{
		...
		{
			return Redirect::to('admin/modifierlevel2/create')->withInput()->withErrors($api_response_data->message);
		} 
	}
	/*** Store Function Ends ***/
	...
	public function show($id)
	{
		...
		{
			$modifiers		 	= 	$api_response_data->data->modifiers;
			return view ( 'admin/modifier/modifierlevel2/show', ['modifiers' => $modifiers] );
		}
		else
		{
			return Redirect::to('admin/modifierlevel2')->with('error', $api_response_data->message);
		}
	}
	/*** Show Function Ends ***/
	...
	{		
		...
		if($api_response_data->status == 'success')
		{
			...
			$modifierstype = $api_response_data->data->modifierstype;
			$modifiers_type_id = $api_response_data->data->modifiers_type_id;
			return view('admin/modifier/modifierlevel2/edit', compact('modifiers','modifierstype','modifiers_type_id'));
		}
		else
		{
			return Redirect::to('admin/modifierlevel2');
		}
	}
	/*** Edit page Ends ***/
	...
	public function destroy($id)
	{
		...
		$api_response_data = $api_response->getData();
		return Redirect::to('admin/modifierlevel2')->with('success',$api_response_data->message);
	}
