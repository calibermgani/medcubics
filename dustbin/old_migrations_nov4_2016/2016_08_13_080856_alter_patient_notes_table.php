...
class AlterPatientNotesTable extends Migration {
	...
	public function up()
	{
		...
		{
			DB::statement("ALTER TABLE `patient_notes` CHANGE `patient_notes_type` `patient_notes_type` ENUM('alert_notes','patient_notes','claim_notes','claim_denial_notes','claim_nis','claim_in_process','claim_paid','claim_denied','left_voice_message','claim_pending') CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL");
		});
	}
